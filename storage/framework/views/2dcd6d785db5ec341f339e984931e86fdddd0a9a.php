    ...
    <script>
        $(document).ready(function() {
            $("#images").change(function () {
                ...
                $.ajax({
                    url: '<?php echo e(route('upload_whitepaper_image')); ?>',
                    type: "POST",
                    data: fd,
                    ...
                    success: function (data) {
                        ...
                        if (data.success == 1) {
                            $('#uploaded-ads-image-wrap').load('<?php echo e(route('append_whitepaper_media_image')); ?>');
                        } else {
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/admin/whitepaper_create.blade.php ENDPATH**/ ?>