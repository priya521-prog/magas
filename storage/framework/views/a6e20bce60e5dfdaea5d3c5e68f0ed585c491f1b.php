				...
				<div class="twodetailpanel row">
					<div class="col-md-8">
						<div class="leftquestionprt">
							...
							<!--<button href="<?php echo url('/');?>/uploads/pdf/<?php echo e($ad->pdffilename); ?> ?>" >Download Brochure</button>-->
								</div>
								</div>
      ...
      <div class="modal-content well well-sm">
        ...
        <div class="modal-body ">
            ...
            <div class="row">
                            ...
                            <input type ="hidden" name="full" id="full"  value="<?php echo url()->full();?>">
                            <div class="col-md-12">
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/theme/modern/whitepaper_ad.blade.php ENDPATH**/ ?>