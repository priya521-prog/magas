				...
				<div class="detailbannerprt">
							...
							<div class="innercontDetail">
								<div class="">
									...
									<img src="../../uploads/placeholder.png" style="width:300px;height:200px">
									<?php } else { ?>
									<img src="../../uploads/businesslogo/<?php echo $ad->business_image;?>" style="width:200px;height:160px">
									<?php } ?>
								</div>
							</div>
				</div>
...
if(filenamecustom !="") {
     var name= '<?php echo $login_name; ?>';
      var email= '<?php echo $login_email; ?>';
       ...
       var selector = $(this);
                ...
                $.ajax({
                    type : 'POST',
                    url : '<?php echo e(route('save_download_data')); ?>',
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/magas21/public_html/resources/views/bizz_adedit.blade.php ENDPATH**/ ?>