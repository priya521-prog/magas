...
I agree to <a href="<?php echo e(route('terms')); ?>" target="_blank" style="color:blue;">terms and conditions</a></label>
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-8">
                                                        ...
                                                        <a href="#" class="custom-button" style="background-color: #d73970;margin: 0px 81px;">
                                                             UPGRADE TO PREMIUM
                                                        </a>
                                                        </div>
    ...
    color: #fff;
    margin-top: 16px;
    display: inline-block;"> PREMIUM BENEFITS</a></div></div>
...
<script type="text/javascript">
 ...
 <div id="myModal1" class="modal fade" role="dialog">
  ...
  <li>10% - Discount on all Services Listed on Portal </li>
...
<div id="myModal2" class="modal fade" role="dialog">
  ...
  <li>10% - Recurring Commission upto 1 year </li>
  <li>10% - Discount on Peer 2 Peer Services  </li>
  <li>PAAS Benefits in terms of Networking & Service Delivery  </li>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/theme/user_create.blade.php ENDPATH**/ ?>