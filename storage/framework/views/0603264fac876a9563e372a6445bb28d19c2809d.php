	...
	<div class="main">
		<div class="custom-container">
			<div class="listingbody">
                            ...
                            <!--<?php if($ad->category): ?>-->
                            <li><a href="<?php echo e(route('projects')); ?>">  All Projects</a> </li>
                            <!--<?php endif; ?>-->
    ...
    //dd($login_id);
       $login_type=$login_user->user_type;
					       ...
					       //if($login_type=='super_admin'){
					          //  if($user==$login_id){
					           ?>
				 	         <a class="btn theme-btn" style="background-color:#191a50;" href="<?php echo e(route('editproject', [$ad->id])); ?>">Edit </a>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/theme/modern/opportunities_adedit.blade.php ENDPATH**/ ?>