...
<?php if($ads->count() > 0): ?>
				...
				<?php } ?>
						...
						<span><i class="fa fa-map-marker"></i><?php echo e($ad->country->country_name); ?></span><br>
							<span><B>Industry:</B> <?php echo e($ad->sub_category->category_name); ?></span><br>
							<span>  <B>Req:</B> <?php echo e($ad->requirement); ?></span>
                           </a>
					</li>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/opportunities.blade.php ENDPATH**/ ?>