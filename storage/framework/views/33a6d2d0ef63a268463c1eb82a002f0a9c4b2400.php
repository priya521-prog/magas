  ...
  <!--<div class="carousel-inner">-->
	...
	<!--<div class="item">-->
				...
				<!--<div class="item active">-->
			      		...
			      		<img src="https://magas.services/uploads/businesslogo/2019-11-19 04:16:41dream days.jpg.jpg" alt="Chicago" style="height:183px">
...
<?php $projects = 1;?>
                        <?php $__currentLoopData = $opportunities_ads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <B>Req:</B> <?php echo e($ad->requirement); ?>
                        ...
                        <?php $__currentLoopData = $whitepapers_ads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 ...
                                 <!--<p><?php echo e($ad->description); ?></p>-->
									...
									<?php } ?>
											 ...
											 <button style="background-color: white;padding: 1px 9px;border:2px solid #191a50;border-radius:12px;margin-top:32px" class="btn btn-primary">  <a href="<?php echo e(route('whitepaper_list')); ?>" style="color:#2c3e50;font-size: 13px;
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\magas_services\resources\views/index.blade.php ENDPATH**/ ?>