...
<div class="main">
 ...
 //dd($payment);
    ?>
                     <a href="javascript:void(0)" class="btn btn-sm btn-primary float-right buy_now" name="pay" id="pay" data-amount="1" data-id="<?php echo $invoice; ?>">Pay Now</a> 
           ...
           "handler": function (response){
                // console.log(response);
                 ...
                 //  url: SITEURL + '/pay-success/' + product_id,
                  // url: SITEURL + '/pay-success',
                  url: '<?php echo e(route('bizz-payment')); ?>',
...
//encode  : true,
       ...
       // response.setHeader("Set-Cookie", "HttpOnly;Secure;SameSite=Strict");
                    ...
                    //  window.location.href = SITEURL + 'thank-you';
                      window.location.href = '<?php echo e(route('bizz-success')); ?>';
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/theme/bizz_payment.blade.php ENDPATH**/ ?>