		...
		<div class="custom-container">
			...
			<div class="listingbody">
				...
				<div class="innerListingbody">
					...
					<div class="innerheading violet" style="font-size:16px">
						ASSOCIATE & EARN
			...
			<div class="row mt-3">
				...
				<div class="col-12" style="padding: 0;">
				   <b>STEP 1: </b><a href="#" class="custom-button" data-toggle="modal" data-target="#myModal2">ASSOCIATE BENEFITS</a><BR><br>
				       <b>STEP 2: </b>          <a href="<?php echo e(asset('assets/downloads/MAGAS-FORM-KYC (6) (2).pdf
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/theme/associate.blade.php ENDPATH**/ ?>