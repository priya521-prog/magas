...
<?php } ?>   
 ...
 <td> <?php echo e($message->aff_code); ?> </td>
      <td><?php echo e($message->fullpageurl); ?></td>
             ...
             <td><a href="<?php echo e(route('deletecontact',[$message->id])); ?>">Delete</a></td>
                            ...
                            <?php echo $contact_messages->links(); ?>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/admin/contact_messages.blade.php ENDPATH**/ ?>