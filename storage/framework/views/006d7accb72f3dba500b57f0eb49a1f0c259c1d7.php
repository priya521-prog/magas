  ...
  <div class="main">
            <div class="custom-container">
                ...
                <?php echo $__env->make('admin.flash_msg', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <div class="row">
                            <div class="col-sm-12">
                        <form action="/bizz/edit/<?php echo e($ads->id); ?>" id="businessadsPostForm" class="form-horizontal" enctype="multipart/form-data" method="post"> <?php echo csrf_field(); ?>
                                <div class="form-tabs">
                                    <ul>
                                        ...
                                        <div class="box">
                                            <div class="add-images">
                                                ...
                                                <div class="custom-file-upload input-row">
                                                        LOGO IMAGE (Recommended 250*250)<br/>
                                                        <span><?php echo e($ads->business_image); ?> </span>
                                                        <input type="file" id="filescustommedia" value="UPLOAD PROFILE PIC" name="filescustommedia" /><br/><br/>
<?php echo $errors->has('filescustommedia')? '<p class="help-block" style="color:red;">Please Upload Image. </p>':''; ?>
						     ...
						     <div class="custom-file-upload input-row">
                                                        COVER IMAGE (Recommended 1020*800)<br/>
                                                        <span><?php echo e($ads->coverimagefilename); ?> </span>
...
<?php echo $errors->has('ad_title')? '<p class="help-block" style="color:red;">Please enter the Title. </p>':''; ?>
                                                     ...
                                                     <div class="input-row">
                                                        <input type="text" name="company_name" id="" class="input-field" value="<?php echo e($ads->company_name); ?>" placeholder="COMPANY NAME"  />
<?php echo $errors->has('company_name')? '<p class="help-block" style="color:red;">Please enter the company name. </p>':''; ?>

                                                    </div>

<!--<div class="input-row">-->
<!--                                                        <input type="text" name="affilate_code" id="affilate_code" class="input-field" value="<?php echo e($ads->affilate_code); ?>" placeholder="AFFILIATE / REFERAL CODE (OPTIONAL)"  />-->
...
<!--                                                    </div>-->
 <div class="input-row">
                            <label for="code">Affiliate Code</label>
                                ...
                                <select class="form-control select2" name="affilate_code">
                                     ...
                                     <?php $__currentLoopData = $query; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $queries): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <?php if($ads->affiliate_code==$queries->affiliate_code): ?>
                                            <option  selected value="<?php echo e($queries->affiliate_code); ?>" ><?php echo e($queries->affiliate_code); ?></option>
                                        <?php else: ?>
						...
						<div class="box-heading">
                                                    About Us
                                                     ...
                                                     <div class="input-row">
						    <textarea name="ad_description" id="ad_description" class="form-control" rows="8"><?php echo e($ads->description); ?></textarea>
                                ...
                                <p class="text-info">  A description will help user to know details about your Business</p>
                                            ...
                                            <div class="box-right">
                                                ...
                                                <div class="sign-up-form">
                                                    <div class="custom-file-upload input-row">
                                                        <span><?php echo e($ads->business_document); ?></span>
                                                        <input type="file" id="filescustomtwo" name="filescustomtwo" /><br/><br/>
							CONTRACT: For Validation purpose only, It will not be published. 
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    <div class="input-row">
                                                        <input type="text" name="seller_name" id="seller_name" class="input-field" value="<?php echo e($ads->seller_name); ?>" placeholder="ENTER FULL NAME"  /> <?php echo $errors->has('seller_name')? '<p class="help-block"style="color:red;">Please enter Full Name.</p>':''; ?>
 ...
 <?php echo $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email id.</p>':''; ?>
                                                    ...
                                                    <div class="input-row">
                                                        <input type="tel" name="seller_phone" id="seller_phone" class="input-field" value="<?php echo e($ads->seller_phone); ?>"  placeholder="+91 9999999999" /> <?php echo $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter the phone no.</p>':''; ?>

                                                    </div>

<div class="custom-file-upload input-row"><span class="box-heading" > COMPANY BROCHURE</span>
                                                    <?php echo e($ads->pdffilename); ?>
 ...
 <div class="input-row"> 
	<input type="text" class="form-control" id="address" value="<?php echo e($ads->address); ?>" name="address" placeholder="<?php echo app('translator')->get('app.address'); ?>">
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/theme/edit_bizz.blade.php ENDPATH**/ ?>