				...
				<div class="innerListingbody" >
					...
					<div class="topdetailintoprt">
						...
						<div class="profinto">
							...
							<p>
							    <?php
							    //$a=str_word_count($ad->seller_name);
							    $words = explode( " ", $ad->seller_name );
							   // dd($words);
...
$t=implode( " ", $e );
						...
						<div class="viewsprt">
								...
								?>
									<!--<button onclick="downloadthefile('<?php echo e($ad->pdffilename); ?>');" >Download CV</button>-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/theme/modern/pro_adedit.blade.php ENDPATH**/ ?>