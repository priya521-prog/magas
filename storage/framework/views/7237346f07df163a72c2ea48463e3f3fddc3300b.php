						     ...
						     <div class="custom-file-upload input-row">
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="ad_title" id="" class="input-field" value="<?php echo e(old('ad_title')); ?>" placeholder="TITLE"/>
...
<!--                                                    </div>-->
 ...
 <?php echo $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email id.</p>':''; ?>
                                                    ...
                                                    <div class="input-row">
                                                     ...
                                                     <div class="input-row">
                                                        <input type="text" name="seller_website" id="seller_website" class="input-field" value="<?php echo e(old('seller_website')); ?>" placeholder="WEBSITE"  />
                                                        <!--<?php echo $errors->has('seller_website')? '<p class="help-block"style="color:red;">Please enter website.</p>':''; ?>-->
                                                    </div>
                                                     <div class="input-row">
                                                        <input type="text" name="social_media_link" id="social_media_link" class="input-field" value="<?php echo e(old('social_media_link')); ?>" placeholder="SOCIAL MEDIA LINK"/>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/theme/create_whitepaper.blade.php ENDPATH**/ ?>