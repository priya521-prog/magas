                                        ...
                                        <div class="box">
                                            <div class="add-images">
                                                <div class="custom-file-upload input-row">
                                                        PROFILE IMAGE (Recommended 250*250)<br/><input type="file" id="filescustommedia" value="UPLOAD PROFILE PIC" name="filescustommedia"  required/><br/><br/>
<!--<?php echo $errors->has('filescustommedia')? '<p class="help-block" style="color:red;">Please Upload your profile picture. </p>':''; ?>-->
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                    <div class="input-row">
                                                        <input type="text" name="ad_title" id="" class="input-field" value="" placeholder="FULL NAME"  required/>
<!--<?php echo $errors->has('ad_title')? '<p class="help-block" style="color:red;">Please enter your full name. </p>':''; ?>-->
                                                    </div>
 <div class="input-row">
                                                        <input type="text" name="designation" id="" class="input-field" value="" placeholder="DESIGNATION"  required/>
<!--<?php echo $errors->has('designation')? '<p class="help-block" style="color:red;">Please enter your designation. </p>':''; ?>-->
                                                    </div>


                                                     <div class="input-row">
                                                        <input type="text" name="company_name" id="" class="input-field" value="" placeholder="LinkedIn URL "  required/>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/admin/create_proad.blade.php ENDPATH**/ ?>