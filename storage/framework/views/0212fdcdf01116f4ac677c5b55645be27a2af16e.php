                                  ...
                                  <div class="box-left">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4">
                                             ...
                                             <p><b>INVOICE #: </b><?php echo $ad->payment_id; ?></p>
                                
 <p><b>NAME:</b> <?php echo $data->name; ?></p>
  <p><B>LOCATION:</B> <?php echo $data->address; ?></p>
                                                       <p><B>PURCHASE ORDER:</B> <?php echo $ad->po_id; ?></p>
...
echo now()->toDateString(); ?></p>
  <p>MAGAS International LLC</p>
   ...
   <p>PO Box 122705, Oud Mehta, Dubai, UAE</p>
                                            <p><b>STATUS:</b> PAID</p>
...
<br><br>
						...
						<p>3. By Buying this product, you agree to the Terms of Use of MAGAS as adverised on its portal.</p>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/admin/bizzsuccess.blade.php ENDPATH**/ ?>