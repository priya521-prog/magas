            ...
            <div class="custom-container">
                ...
                <?php echo $__env->make('admin.flash_msg', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                        <form action="/projects/edit/<?php echo e($ads->id); ?>" id="businessadsPostForm" class="form-horizontal" enctype="multipart/form-data" method="post"> <?php echo csrf_field(); ?>
                                <div class="form-tabs">
                                    <ul>
                                        ...
                                        <div class="box">
                                            <div class="add-images">
                                                <div class="custom-file-upload input-row">
                                                        LOGO IMAGE (Recommended 250*250)<br/><span><?php echo e($ads->business_image); ?> </span>
                                                        <input type="file" id="filescustommedia"  name="filescustommedia" /><br/><br/>
<?php echo $errors->has('filescustommedia')? '<p class="help-block" style="color:red;">Please Upload Image. </p>':''; ?>
						     ...
						     <div class="custom-file-upload input-row">
                                                        COVER/PROFILE IMAGE (RECOMMENDED 851*315)<br/>
...
<div class="input-row">
                                                        <input type="text" name="affilate_code" id="affilate_code" class="input-field" value="<?php echo e($ads->affiliate_code); ?>" placeholder="AFFILIATE / REFERAL CODE (OPTIONAL)"  />
 ...
 <?php echo $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email id.</p>':''; ?>
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="seller_req" id="seller_req" class="input-field" value="<?php echo $ads->requirement; ?>" placeholder="REQUIREMENT"/>
...
<div class="custom-file-upload input-row"><span class="box-heading" > COMPANY BROCHURE</span>
 ...
 <div class="input-row"> 
	<input type="text" class="form-control" id="address" value="<?php echo e($ads->address); ?>" name="address" placeholder="LOCATION">
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/theme/edit_project.blade.php ENDPATH**/ ?>