...
<?php $__env->startSection('main'); ?>
                                        ...
                                        <div class="box">
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                      <div class="input-row">
                                                        <input type="text" name="seller_name" id="seller_name" class="input-field" value="" placeholder="ENTER FULL NAME"  required/> <?php echo $errors->has('seller_name')? '<p class="help-block"style="color:red;">Please enter your full name</p>':''; ?>
 ...
 <?php echo $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter your Email Id</p>':''; ?>

                                                    </div>
                                                    <div class="input-row">
                                                        <input type="tel" name="seller_phone" id="seller_phone" class="input-field" value="" placeholder="MOBILE NO"  required/> <?php echo $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter your phone no.</p>':''; ?>

                                                    </div>
<div class="custom-file-upload input-row"><span class="box-heading" required> UPLOAD PROJECT</span>
						...
						<div class="box-heading">
						    ...
						    <textarea name="ad_description" id="ad_description" class="form-control" rows="8" required></textarea>
                                <?php echo $errors->has('ad_description')? '<p class="help-block" style="color:red;">Please enter the PROJECT SYNOPSIS. </p>':''; ?>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/theme/freeevaluation.blade.php ENDPATH**/ ?>