				...
				<div class="custom-container">
					<div class="fulltop">
						...
						<div class="loginbuttonprt">
							...
							<a href="<?php echo e(route('user.create')); ?>" id="changecolor">
								Signup
							</a><a href="<?php echo e(route('login')); ?>" id="changecolor">
								Login
							</a>
						</div>
                                              <?php endif; ?>
...
<?php /**PATH /home/beta1magas/public_html/resources/views/layout/header-front.blade.php ENDPATH**/ ?>