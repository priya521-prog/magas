           ...
           "handler": function (response){
                // console.log(response);
                 ...
                 //  url: SITEURL + '/pay-success/' + product_id,
                  // url: SITEURL + '/pay-success',
                  url: '<?php echo e(route('startup-payment')); ?>',
...
//encode  : true,
       ...
       // response.setHeader("Set-Cookie", "HttpOnly;Secure;SameSite=Strict");
                    ...
                    //  window.location.href = SITEURL + 'thank-you';
                      window.location.href = '<?php echo e(route('startup-success')); ?>';
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/theme/package_payment.blade.php ENDPATH**/ ?>