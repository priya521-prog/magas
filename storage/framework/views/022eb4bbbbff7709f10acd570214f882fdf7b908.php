...
<?php if($ads->count() > 0 && $ads->count() != 1): ?>
...
<br>			    <div class="row">
				...
				<?php } ?>
						...
						<h2 style="font-size: 15px;text-transform: capitalize; text-transform: uppercase;" ><?php echo e($ad->title); ?></h2>
						
						<span style="font-size: 18px; line-height: 2;"><?php echo e($ad->sub_category->category_name); ?></span><br>
						
						<span style="font-size: 16px; line-height: 2;"><?php echo e($ad->servicename); ?></span><br>
							
						<i class="fa fa-map-marker" style="font-size: 16px; "></i><span style="font-size: 14px; ">  <?php echo e($ad->country->country_name); ?> </span>
                           </a>
    ...
    <!--                                                                   <?php if ($ad->business_image== "") { ?>-->
				...
				<!--		</div>          				-->
						<!--<h3 ><?php echo e($ad->title); ?></h3>-->
				<!--		<h2 style="font-size: 12px;text-transform: capitalize;"><?php echo e($ad->title); ?></h2>-->
				<!--		<span style="font-size: 12px;"><?php echo e($ad->sub_category->category_name); ?></span><br>-->
				<!--			<span style="font-size: 12px;"><?php echo e($ad->servicename); ?></span><br>-->
				<!--		<span style="font-size: 12px;"><i class="fa fa-map-marker"></i><?php echo e($ad->country->country_name); ?></span>-->
    <!--                       </a>-->
					</li>
					</div>
					</div>
      ...
      <!--                                              <a href="<?php echo e(route('single_ad', [$ad->id, $ad->slug])); ?>">-->
						...
						<!--	<h3><?php echo e($ad->sub_category->category_name); ?></h3>-->
					        	<!--<span>	<?php echo e($ad->created_at); ?></span>-->
					          	<!--<h3><?php echo e($ad->description); ?></h3>   -->
   ...
   <?php if($ads->count() <= 1): ?>
   	...
   	<ul>
				...
				<?php } ?>
						...
						<span style="font-size: 16px; line-height: 2;"><?php echo e($ad->sub_category->category_name); ?></span><br>
						
							<span style="font-size: 15px; line-height: 2;"><?php echo e($ad->servicename); ?></span><br>
							
						<i class="fa fa-map-marker" style="font-size: 15px;"></i><span style="font-size: 14px; ">  <?php echo e($ad->country->country_name); ?> </span>
                           </a>
...
<br>			    <div class="row">
				...
				<?php } ?>
						...
						<!--<h3 ><?php echo e($ad->title); ?></h3>-->
						<h2 style="font-size: 18px;text-transform: capitalize; text-transform: uppercase;" ><?php echo e($ad->title); ?></h2>
						
						<span style="font-size: 18px; line-height: 2;"><?php echo e($ad->sub_category->category_name); ?></span><br>
						
						<span style="font-size: 16px; line-height: 2;"><?php echo e($ad->servicename); ?></span><br>
							
						<i class="fa fa-map-marker" style="font-size: 15px; "></i><span style="font-size: 16px;">  <?php echo e($ad->country->country_name); ?> </span>
                           </a>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/magas21/public_html/resources/views/bizz.blade.php ENDPATH**/ ?>