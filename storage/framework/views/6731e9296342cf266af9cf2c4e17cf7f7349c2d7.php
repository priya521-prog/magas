...
<!--<?php echo $errors->has('filescustommedia')? '<p class="help-block" style="color:red;">Please Upload Image. </p>':''; ?>-->
						     ...
						     <div class="custom-file-upload input-row">
                                                        COVER/PROFILE IMAGE (RECOMMENDED 851*315)<br/><input type="file" id="file" value="UPLOAD PROFILE PIC" name="filescustomone" />
                                                        <div class="clearfix"></div>
                                                    </div>
                                            </div>
                                            <div class="clearfix"></div>
...
<!--                                                    </div>-->
 ...
 <!--<?php echo $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email id.</p>':''; ?>-->
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="seller_req" id="seller_req" class="input-field" value="" placeholder="REQUIREMENT" required />
...
<div class="custom-file-upload input-row"><span class="box-heading" > COMPANY BROCHURE</span>
 ...
 <div class="input-row"> 
	<input type="text" class="form-control" id="address" value="" name="address" placeholder="LOCATION" required>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/theme/createprojects.blade.php ENDPATH**/ ?>