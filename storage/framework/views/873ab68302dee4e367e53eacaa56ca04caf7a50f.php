...
<?php if ($ad->business_image== "") { ?>
	...
	?>
									    <img src="<?php echo url('/');?>/uploads/placeholder.png" style="width:90px;height: 90px;
...
<?php $projects = 1;?>
 ...
 <?php
	...
	if(Auth::user()){
					?>
                                               <a href="<?php echo e(route('single_ad', [$ad->id, $ad->slug])); ?>" style="
...
?><br>
							...
							<div id="blogs" class="tab-pane fade">
							    <?php $i=1; ?>
							       ...
							       <!--<a href="<?php echo e(route('blog_single', $ad1->id)); ?>" class="blog-title">-->
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/theme/modern/index.blade.php ENDPATH**/ ?>