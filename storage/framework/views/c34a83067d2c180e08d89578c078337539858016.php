  ...
  <div class="main">
            <div class="custom-container">
                ...
                <?php echo $__env->make('admin.flash_msg', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <div class="row">
                            <div class="col-sm-12">
                        <form action="" id="profileadsPostForm" class="form-horizontal" enctype="multipart/form-data" method="post"> <?php echo csrf_field(); ?>
                                <div class="form-tabs">
                                    <ul>
                                        ...
                                        <div class="box">
                                            <div class="add-images">
                                                <div class="custom-file-upload input-row">
                                                        PROFILE IMAGE (Recommended 250*250)<br/><input type="file" id="filescustommedia" value="UPLOAD PROFILE PIC" name="filescustommedia"/><br/><br/>
<?php echo $errors->has('filescustommedia')? '<p class="help-block" style="color:red;">Please Upload your profile picture. </p>':''; ?>
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                    <div class="input-row">
                                                        <input type="text" name="ad_title" id="" class="input-field" value="<?php echo e(old('ad_title')); ?>" placeholder="FULL NAME"/>
<?php echo $errors->has('ad_title')? '<p class="help-block" style="color:red;">Please enter your full name. </p>':''; ?>

                                                    </div>
 <div class="input-row">
                                                        <input type="text" name="designation" id="" class="input-field" value="<?php echo e(old('designation')); ?>" placeholder="DESIGNATION"/>
<?php echo $errors->has('designation')? '<p class="help-block" style="color:red;">Please enter your designation. </p>':''; ?>

                                                    </div>


                                                     <div class="input-row">
                                                        <input type="text" name="company_name" id="" class="input-field" value="<?php echo e(old('company_name')); ?>" placeholder="LinkedIn URL "/>
<!--<?php echo $errors->has('company_name')? '<p class="help-block" style="color:red;">Please enter your LinkedIn URL. </p>':''; ?>-->
                                                    </div>
						<div class="box-heading">
                                                    PROFILE SKILLSETS , QUALIFICATIONS & DESCRIPTION
                                                </div>	
                                                     <div class="input-row">
 ...
 <?php echo $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email address.</p>':''; ?>
...
<div class="custom-file-upload input-row">
		<span class="box-heading" > Upload CV</span>
                                                        <input type="file" id="filescustom" name="filescustom" value="<?php echo e(old('filescustom')); ?>"/><br/><br/>
                                                      							<?php echo $errors->has('filescustom')? '<p class="help-block"style="color:red;">Please upload
							CV.</p>':''; ?>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/admin/create_proad.blade.php ENDPATH**/ ?>