        ...
        <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="form-group <?php echo e($errors->has('title')? 'has-error':''); ?>">
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="title" value="<?php echo e(old('title')); ?>" name="title" placeholder="Page Title">
			...
			<div class="form-group <?php echo e($errors->has('images')? 'has-error':''); ?>">
                        ...
                        <div class="form-group">
                            <div class="col-sm-9">
                                <button type="submit" class="btn btn-primary"><?php echo app('translator')->get('app.save_new_page'); ?></button>
                            </div>
                        </div>
                        </form>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/beta/resources/views/admin/page_create.blade.php ENDPATH**/ ?>