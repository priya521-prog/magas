                                        ...
                                        <div class="box">
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                      <div class="input-row">
                                                        <input type="text" name="seller_name" id="seller_name" class="input-field" value="" placeholder="ENTER FULL NAME"  required/> {!! $errors->has('seller_name')? '<p class="help-block"style="color:red;">Please enter your full name</p>':'' !!}

                                                    </div>
                                                  
                                                    <div class="input-row">
                                                        <input type="email" name="seller_email" id="" class="input-field" value="" placeholder="EMAIL"  required/>
 {!! $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter your Email Id</p>':'' !!}
                                                    </div>
                                                    <div class="input-row">
                                                        <input type="tel" name="seller_phone" id="seller_phone" class="input-field" value="" placeholder="MOBILE NO"  required/> {!! $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter your phone no.</p>':'' !!}
                                                    </div>
<div class="custom-file-upload input-row"><span class="box-heading" required> UPLOAD PROJECT</span>
						...
						<div class="box-heading">
						    ...
						    <textarea name="ad_description" id="ad_description" class="form-control" rows="8" required></textarea>
                                {!! $errors->has('ad_description')? '<p class="help-block" style="color:red;">Please enter the PROJECT SYNOPSIS. </p>':'' !!}
