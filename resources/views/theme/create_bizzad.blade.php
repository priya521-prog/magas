                                        ...
                                        <div class="box">
                                            <div class="add-images">
                                                <div class="custom-file-upload input-row">
                                                        LOGO IMAGE (Recommended 250*250)<br/><input type="file" id="filescustommedia" value="UPLOAD PROFILE PIC" name="filescustommedia" /><br/><br/>
...
{!! $errors->has('ad_title')? '<p class="help-block" style="color:red;">Please enter the Title. </p>':'' !!}
                                                     ...
                                                     <div class="input-row">
                                                        <input type="text" name="company_name" id="" class="input-field" value="{{ old('company_name') }}" placeholder="COMPANY NAME"  />
                 ...
                 <div class="input-row">
                                ...
                                <select class="form-control select2" name="affilate_code">
                                    ...
                                    @foreach($query as $queries)
                                        <!--<option value="{{ $queries->affiliate_code }}">{{ $queries->affiliate_code }}</option>-->
                                          ...
                                          <option value="{{ $queries->affiliate_code }}" {{ old('affilate_code') == '$queries->affiliate_code' ? 'selected' :'' }}>{{ $queries->affiliate_code }}</option>
                                    @endforeach
                                </select>
						...
						<div class="box-heading">
							...
							CONTRACT: For Validation purpose only, It will not be published. 
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="seller_name" id="seller_name" class="input-field" value="{{ old('seller_name') }}" placeholder="ENTER FULL NAME"/>
...
<span class="word_preview"></span>
 ...
 {!! $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email id.</p>':'' !!}
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="seller_phone" id="seller_phone" class="input-field" value="{{ old('seller_phone') }}"  placeholder="ENTER PHONE"/> 
...
<!--</div>-->
<div class="input-row">
                                                        <input type="text" name="address" id="address" class="input-field" value="{{ old('address') }}" placeholder="LOCATION"/>
 {!! $errors->has('address')? '<p class="help-block"style="color:red;">Please enter location</p>':'' !!}
                                                    </div>
