            ...
            <div class="custom-container">
                ...
                @include('admin.flash_msg')
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                        <form action="/projects/edit/{{$ads->id}}" id="businessadsPostForm" class="form-horizontal" enctype="multipart/form-data" method="post"> @csrf
                                <div class="form-tabs">
                                    <ul>
                                        ...
                                        <div class="box">
                                            <div class="add-images">
                                                <div class="custom-file-upload input-row">
                                                        LOGO IMAGE (Recommended 250*250)<br/><span>{{$ads->business_image }} </span>
...
<div class="input-row">
                                                        <input type="text" name="affilate_code" id="affilate_code" class="input-field" value="{{ $ads->affiliate_code}}" placeholder="AFFILIATE / REFERAL CODE (OPTIONAL)"  />
...
<div class="custom-file-upload input-row"><span class="box-heading" > COMPANY BROCHURE</span>
 ...
 <div class="input-row"> 
	<input type="text" class="form-control" id="address" value="{{$ads->address}}" name="address" placeholder="LOCATION">
