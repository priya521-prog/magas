  ...
  <div class="main">
            <div class="custom-container">
                ...
                @include('admin.flash_msg')
                        <div class="row">
                            <div class="col-sm-12">
                        <form action="/pro/edit/{{$ads->id}}" id="profileadsPostForm" class="form-horizontal" enctype="multipart/form-data" method="post"> @csrf
                                <div class="form-tabs">
                                    <ul>
...
{!! $errors->has('filescustommedia')? '<p class="help-block" style="color:red;">Please Upload your profile picture. </p>':'' !!}
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                    <div class="input-row">
                                                        <input type="text" name="ad_title" id="" class="input-field" value="{{$ads->title }}" placeholder="FULL NAME"  />
{!! $errors->has('ad_title')? '<p class="help-block" style="color:red;">Please enter your full name. </p>':'' !!}
                                                    </div>
 <div class="input-row">
                                                        <input type="text" name="designation" id="" class="input-field" value="{{$ads->designation }}" placeholder="DESIGNATION"  />
