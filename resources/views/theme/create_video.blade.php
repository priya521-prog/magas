...
<!--                                                    </div>-->
<!--                                                    <div class="input-row">-->
<!--                                                        <input type="tel" name="seller_phone" id="seller_phone" class="input-field" value="" placeholder="CONTACT NO"  /> {!! $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter the phone no.</p>':'' !!}-->
<!--                                                    </div>-->
<!--                                                     <div class="input-row">-->
<!--                                                        <input type="text" name="seller_website" id="seller_website" class="input-field" value="" placeholder="WEBSITE"  /> {!! $errors->has('seller_website')? '<p class="help-block"style="color:red;">Please enter website.</p>':'' !!}-->
<!--                                                    </div>-->
<!--                                                     <div class="input-row">-->
<!--                                                        <input type="text" name="social_media_link" id="social_media_link" class="input-field" value="" placeholder="SOCIAL MEDIA LINK"  /> {!! $errors->has('social_media_link')? '<p class="help-block"style="color:red;">Please enter social media link.</p>':'' !!}-->
<!--                                                    </div>-->
