  ...
  <div class="main">
            <div class="custom-container">
                ...
                @include('admin.flash_msg')
                        <div class="row">
                            <div class="col-sm-12">
                        <form action="/bizz/edit/{{$ads->id}}" id="businessadsPostForm" class="form-horizontal" enctype="multipart/form-data" method="post"> @csrf
                                <div class="form-tabs">
                                    <ul>
...
{!! $errors->has('filescustommedia')? '<p class="help-block" style="color:red;">Please Upload Image. </p>':'' !!}
						     ...
						     <div class="custom-file-upload input-row">
                                                        ...
                                                        <span>{{$ads->coverimagefilename }} </span>
...
{!! $errors->has('ad_title')? '<p class="help-block" style="color:red;">Please enter the Title. </p>':'' !!}
                                                     ...
                                                     <div class="input-row">
                                                        <input type="text" name="company_name" id="" class="input-field" value="{{$ads->company_name}}" placeholder="COMPANY NAME"  />
{!! $errors->has('company_name')? '<p class="help-block" style="color:red;">Please enter the company name. </p>':'' !!}
                                                    </div>

<!--<div class="input-row">-->
<!--                                                        <input type="text" name="affilate_code" id="affilate_code" class="input-field" value="{{$ads->affilate_code}}" placeholder="AFFILIATE / REFERAL CODE (OPTIONAL)"  />-->
...
<!--                                                    </div>-->
 <div class="input-row">
                            <label for="code">Affiliate Code</label>
                                ...
                                <select class="form-control select2" name="affilate_code">
                                     ...
                                     @foreach($query as $queries)
                                         @if($ads->affiliate_code==$queries->affiliate_code)
                                            <option  selected value="{{ $queries->affiliate_code }}" >{{ $queries->affiliate_code }}</option>
                                        @else
						...
						<div class="box-heading">
                                                    About Us
                                                     ...
                                                     <div class="input-row">
						    <textarea name="ad_description" id="ad_description" class="form-control" rows="8">{{$ads->description}}</textarea>
                                ...
                                <p class="text-info">  A description will help user to know details about your Business</p>
                                            ...
                                            <div class="box-right">
                                                ...
                                                <div class="sign-up-form">
                                                    <div class="custom-file-upload input-row">
                                                        <span>{{$ads->business_document }}</span>
                                                        <input type="file" id="filescustomtwo" name="filescustomtwo" /><br/><br/>
							CONTRACT: For Validation purpose only, It will not be published. 
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    <div class="input-row">
                                                        <input type="text" name="seller_name" id="seller_name" class="input-field" value="{{$ads->seller_name}}" placeholder="ENTER FULL NAME"  /> {!! $errors->has('seller_name')? '<p class="help-block"style="color:red;">Please enter Full Name.</p>':'' !!}
 ...
 {!! $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email id.</p>':'' !!}
                                                    ...
                                                    <div class="input-row">
                                                        <input type="tel" name="seller_phone" id="seller_phone" class="input-field" value="{{$ads->seller_phone}}"  placeholder="+91 9999999999" /> {!! $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter the phone no.</p>':'' !!}
                                                    </div>
...
<div class="custom-file-upload input-row"><span class="box-heading" > COMPANY BROCHURE</span>
 ...
 <div class="input-row"> 
	<input type="text" class="form-control" id="address" value="{{$ads->address}}" name="address" placeholder="@lang('app.address')">
