...
@section('main')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-tabs">
                                    ...
                                    {!! $errors->has('first_name')? '<p class="help-block" style="color:red;font-weight:bold;">*'.$errors->first('first_name').'</p>':'' !!}
                                    {!! $errors->has('last_name')? '<p class="help-block" style="color:red;font-weight:bold;">*'.$errors->first('last_name').'</p>':'' !!}
                                    {!! $errors->has('email')? '<p class="help-block" style="color:red;font-weight:bold;">*'.$errors->first('email').'</p>':'' !!}
                                    {!! $errors->has('password')? '<p class="help-block" style="color:red;font-weight:bold;">*'.$errors->first('password').'</p>':'' !!}
                                    {!! $errors->has('phone')? '<p class="help-block" style="color:red;font-weight:bold;">*'.$errors->first('phone').'</p>':'' !!}
                                    {!! $errors->has('country')? '<p class="help-block" style="color:red;font-weight:bold;"> *'.$errors->first('country').'</p>':'' !!}
                     <?php
				$texthere = "Please click on your interests.";
				$texthereone = "Please read the terms and click Agree.";
			?>                  
                                    {!! $errors->has('interests')? '<p class="help-block" style="color:red;font-weight:bold;"> *'.$texthere.'</p>':'' !!}              
                                    {!! $errors->has('agree')? '<p class="help-block" style="color:red;font-weight:bold;"> *'.$texthereone.'</p>':'' !!}              
 ...
 <ul>
                    ...
                    <form action="{{route('user.store')}}" role="form" method="post" onsubmit="myFunction()"> @csrf
                                            <div class="sign-up-form">
                                                 <input name="account_type" type="checkbox" checked value="standardaccess" readonly />STANDARD USER
                                                <div class="input-row">
                                                    <input type="text" name="first_name" id="first_name" class="input-field" value="{{ old('first_name') }}"  placeholder="FIRST NAME"  />
                                                </div>
                                                <div class="input-row">
                                                    <input type="text" name="last_name" id="last_name" class="input-field" value="{{ old('last_name') }}" placeholder="LAST NAME"  />
                                                </div>
                                                 <div class="input-row">
                                                    <input type="email" name="email" id="email" value="{{ old('email') }}"  class="input-field" value="" placeholder="EMAIL"  />
                                                </div>
                                                <div class="input-row">
                                               ...
                                               <div class="input-row">
                                                ...
                                                <div class="input-row">
                                                    <input type="tel"  name="phone" id="phone" class="input-field" value="{{ old('phone') }}"  placeholder="MOBILE NO"  />
                                                </div>
						...
						<div class="input-row">
							<div class="select">
								...
								<option value="">Select Gender</option>
                                                  ...
                                                  <div class="input-row">
                                                    <input type="text"  name="address" id="address" class="input-field" value="{{ old('address') }}"  placeholder="ADDRESS"  />
                                                </div>
                                                <div class="input-row">
                                                    <div class="select">
					...
					<div class="input-row input-row-border-none" style="display: none;">
                         ...
                         <hr />
                                         <div class="well" id="price_summery" style="display: none;">
                                                    ...
                                                    <span id="payable_amount">{{ get_option('regular_ads_price') }} </span>$ USD PER ANNUM. 
                                                </div>
...
I agree to <a href="{{ route('terms') }}" target="_blank" style="color:blue;">terms and conditions</a></label>
                                                                        </div>
                                                                        <div class="clearfix"></div>
                                                </div>
