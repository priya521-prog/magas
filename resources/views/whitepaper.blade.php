...
.innerListingbody ul li {
	...
	<!--<div class="buttonrightpart" style="float:right;margin-top:-12px">		<a href="{{ route('create_your_whitepaper') }}" class="postbutton">POST A WHITEPAPER</a></div>-->
	<?php
