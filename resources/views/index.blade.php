      ...
      <!--</div>-->
                            ...
                            @foreach($sliders as $slider)
                                <div class="item {{ $i==0? 'active':'' }}">
                                   <a href="{{ $slider->url }}" id="slider_url" target="_blank"><img src="{{ slider_url($slider) }}" alt="Image one" style="width:100%;"></a> 
					...
					<div class="btn-group" data-toggle="buttons">
					  <label class="btn btn-light-blue form-check-label form-check-labelBorder active">
						<input class="form-check-input" type="radio" name="options" id="option1" autocomplete="off" checked>
						   <a href="{{ route('catalogue') }}">ALA-Carte</a>
					  </label>
					  <label class="btn btn-light-blue form-check-label form-check-labelBorder">
						<input class="form-check-input" type="radio" name="options" id="option2" autocomplete="off"> <a  href="{{ route('bespoke') }}" style="cursor: pointer;">
									BESPOKE
								</a>
					  </label>
					  <label class="btn btn-light-blue form-check-label">
						<input class="form-check-input" type="radio" name="options" id="option3" autocomplete="off"> <a href="{{ route('packages') }}">Packages</a>
					  </label>
					</div>
				</div>
	...
	<div class="row bannerRow mrt25">
        <div class="container pad0">
			<div class="card form_card">
				...
				<h3 class="h3">LATEST IN <b><a href="{{ route('bizz') }}">Bizz</a></b>
				<div class="smallViewAll"><a href="{{ route('bizz') }}">View All</a></div>
				<div class="smallPinkbutt"><a href="{{ route('advertise') }}" target="_blank">Advertise With Us</a></div>
				</h3>
				@if($bizz_ads->count() > 0)
				<?php $i = 1;?>
				...
				<div class="bizzContaner">
					...
					<div class="bizzTextContaner">
						<div class="bizzHeadline"><a href="">{{ $ad->title }}</a></div>
						<div class="bizzSection"><span>{{ $ad->sub_category->category_name }}</span>  |  <span>{{ $ad->servicename }}</span></div>
						<div class="bizzLocation">{{ $ad->country->country_name  }}</div>
			   ...
			   <?php if ($i++ == 5) break; ?>             
				...
				<div class="col-md-12 mrt25">
					<div class="col-md-8 col-xs-12 pad0">
						<h3 class="h3">Featured <b><a href="{{ route('pro') }}">PRO</a></b>
						<div class="smallViewAll"><a href="{{ route('pro') }}">View All</a></div>
						</h3>
						@if($pro_ads->count() > 0)
						<?php $pro = 1;?>
...
$t=implode( " ", $e );
		echo $t;										    ?></a></div>
							<div class="proSection">{{ $ad->designation }}</div>
							<div class="proLocation">{{ $ad->country->country_name }}</div>
							</div>
						</div>
						<?php if ($pro++ == 6) break; ?>
							@endforeach
					...
					<div class="col-md-4 col-xs-12">
						...
						<div class="smallViewAll"><a href="{{  route('classifieds') }}">View All</a></div>
						</h3>
						<div class="mrt25">
						...
						<div class="classContaner">
							...
							<div class="classLocation">{{ $ad->country->country_name }}</div>
						</div>
						</a>
				...
				<div class="col-md-12 mrt25">
					<div class="col-md-8 col-xs-12 pad0">
						...
						<div class="OpportunitiesContaner">
							...
							<div class="opportunitiesHeadline"><a href="">{{ $ad->title }}</a></div>
