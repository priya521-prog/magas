...
<!--<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">-->
	...
	?>
									...
									<img src="<?php echo url('/');?>/uploads/placeholder.png" style="width:120px;height:120px">
									<?php } else { ?>
		...
		<div class="row margintop">
				...
				<div class="col-md-7">
					...
					<div class="tabpanel padnone">
						...
						<li style="float: left; margin-left: 0px;background: #1D2053!important">	<a class="isDisabled" style="color:white">
								PRO
								</a></li>
