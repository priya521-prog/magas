	...
	<div class="main" >
		<div class="custom-container">
			<div class="listingbody">
                            ...
                            <!--@if($ad->category)-->
                            <!--<li><a href="{{ route('bizz', ['category' => $ad->category->id]) }}">  All Business Listing </a> </li>-->
                            <li><a href="{{ route('bizz', ['category' => $ad->category->id]) }}">  All Bizz </a> </li>
                            <!--@endif-->
            ...
            <div class="row">
                            <div class="col-md-12">
                                <div class="form-group {{ $errors->has('name')? 'has-error':'' }}">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="@lang('app.enter_name')" readonly value="<?php echo $login_name; ?>"/>
                                    {!! $errors->has('name')? '<p class="help-block">'.$errors->first('name').'</p>':'' !!}
                                </div>
                                <div class="form-group {{ $errors->has('email')? 'has-error':'' }}">
                                    <label for="email">@lang('app.email_address')</label>
                                        <input type="email" class="form-control" id="email" placeholder="@lang('app.enter_email_address')" name="email" value="<?php echo $login_email; ?>" readonly />
...
<input type ="hidden" name="fullpageurl" id="fullpageurl"  value="<?php echo url()->full();?>">
	...
	<div class="clearfix"></div>
	 <center>
   <div>
       <a class="btn theme-btn" style="background-color:#e8215a;margin-top:-12px" href="{{route('previousad',[$ad->id]) }}"> < </a>&nbsp &nbsp &nbsp
