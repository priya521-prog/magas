    ...
    <div class="col-lg-12">
                                        ...
                                        <div class="box-right">
                                           <div class="link">
                                                ...
                                                <!--<a href="{{ route('initiatepayments') }}" class="custom-button">Upgrade To Premium</a><br>-->
                                                 <a href="{{ route('premium_update') }}" class="custom-button">Upgrade To Premium</a><br>
                                                 
                                                  <!--<a href="{{ route('my-store') }}" class="custom-button">Upgrade To Premium</a><br>-->
                                            ...
                                            <!--<a href="{{ route('invoice') }}" class="custom-button">Upgrade To Premium</a>-->
                                            </div>
