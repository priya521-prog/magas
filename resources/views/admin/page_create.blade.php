            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form action="" id="createPageForm" class="form-horizontal" enctype="multipart/form-data" method="post"> @csrf

                        <div class="form-group {{ $errors->has('title')? 'has-error':'' }}">
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="title" value="{{ old('title') }}" name="title" placeholder="Page Title">
            ...
            $("#images").change(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success == 1) {
                            $('#uploaded-ads-image-wrap').load('{{ route('append_page_media_image') }}');
                        } else {
