  ...
  <div class="main">
            <div class="custom-container">
                ...
                @include('admin.flash_msg')
                        <div class="row">
                            <div class="col-sm-12">
                        <form action="" id="profileadsPostForm" class="form-horizontal" enctype="multipart/form-data" method="post"> @csrf
                                <div class="form-tabs">
                                    <ul>
...
{!! $errors->has('filescustommedia')? '<p class="help-block" style="color:red;">Please Upload your profile picture. </p>':'' !!}
                                                        <div class="clearfix"></div>
                                                </div>
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                    <div class="input-row">
                                                        <input type="text" name="ad_title" id="" class="input-field" value="{{ old('ad_title') }}" placeholder="FULL NAME"/>
{!! $errors->has('ad_title')? '<p class="help-block" style="color:red;">Please enter your full name. </p>':'' !!}
                                                    </div>
 <div class="input-row">
                                                        <input type="text" name="designation" id="" class="input-field" value="{{ old('designation') }}" placeholder="DESIGNATION"/>
{!! $errors->has('designation')? '<p class="help-block" style="color:red;">Please enter your designation. </p>':'' !!}
                                                    </div>


                                                     <div class="input-row">
                                                        <input type="text" name="company_name" id="" class="input-field" value="{{ old('company_name') }}" placeholder="LinkedIn URL "/>
<!--{!! $errors->has('company_name')? '<p class="help-block" style="color:red;">Please enter your LinkedIn URL. </p>':'' !!}-->
                                                    </div>
 ...
 {!! $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email address.</p>':'' !!}
                                                    </div>
                                                    <div class="input-row">
...
<div class="custom-file-upload input-row">
		<span class="box-heading" > Upload CV</span>
                                                        <input type="file" id="filescustom" name="filescustom" value="{{ old('filescustom') }}"/><br/><br/>
                                                      							{!! $errors->has('filescustom')? '<p class="help-block"style="color:red;">Please upload
							CV.</p>':'' !!}
                                                        <div class="clearfix"></div>
                                                    </div>
						    <div class="input-row">
