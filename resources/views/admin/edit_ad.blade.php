                ...
                <div class="row">
                    <div class="col-md-10 col-xs-12">
                        ...
                        <div class="form-group {{ $errors->has('ad_description')? 'has-error':'' }}">
                            ...
                            <div class="col-sm-8">
                                <textarea name="ad_description" id="ad_description" class="form-control" rows="8">{{ old('ad_description')?  old('ad_description') : $ad->description }}</textarea>
                        ...
                        <div class="form-group required {{ $errors->has('type')? 'has-error':'' }}">
                            ...
                            <div class="col-md-8">
                                <label for="type_bizz" class="radio-inline">
                                    <input type="radio" value="bizz" id="type_bizz" name="type"  {{ $ad->type == 'bizz'? 'checked="checked"' : '' }}>
                                           @lang('app.bizz')
                                </label>
                                <label for="type_pro" class="radio-inline">
                                    <input type="radio" value="pro" id="type_pro" name="type" {{ $ad->type == 'pro'? 'checked="checked"' : '' }}>

                                           @lang('app.pro')
                                </label>
                                <label for="type_classifieds" class="radio-inline">
                                    <input type="radio" value="classifieds" id="type_classfields" name="type" {{ $ad->type == 'classifieds'? 'checked="checked"' : '' }}>

                                           @lang('app.classifieds')
                                </label>
                                <label for="type_opportunities" class="radio-inline">
                                    <input type="radio" value="opportunities" id="type_opportunities" name="type" {{ $ad->type == 'opportunities'? 'checked="checked"' : '' }}>

                                           <!--@lang('app.opportunities')-->
                                           Projects
                                </label>
                                <label for="type_whitepapers" class="radio-inline">
                                    <input type="radio" value="whitepapers" id="type_whitepapers" name="type" {{ $ad->type == 'whitepapers'? 'checked="checked"' : '' }}>

                                           @lang('app.whitepapers')
                                </label>
...
<!-- Santhosh Adding Custom field -->
			...
			<div class="form-group" id="fileone">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="designation" value="{{ $ad->designation }}" name="designation" placeholder="Custom Field(Designation,Current Role)')">
                            </div>
                        </div>
						...
						Uploaded File <a href="<?php echo url('/');?>/uploads/pdf/{{ $ad->pdffilename }}" target="_BLANK" style="color:blue;">{{ $ad->pdffilename }}</a>
                                        </label>
                                    </div>
                                </div>
                            </div>
