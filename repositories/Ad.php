...
class Ad extends Model
{
    ...
    public function scopeActiveBizz($query){
         return $query->whereStatus('1')->whereType('bizz');
      //  return $query->whereType('bizz');
    }
    public function scopeActivePro($query){
        return $query->whereStatus('1')->whereType('pro');
    }
    public function scopeActiveClassifieds($query){
        return $query->whereStatus('1')->whereType('classifieds');
    }
    public function scopeActiveOpportunities($query){
        return $query->whereStatus('1')->whereType('opportunities');
    }
    public function scopeActiveWhitepapers($query){
        return $query->whereStatus('1')->whereType('whitepapers');
    }
    // public function scopeActiveBlogs($query){
    //     return $query->whereStatus('1')->whereType('blogs');
    // }
