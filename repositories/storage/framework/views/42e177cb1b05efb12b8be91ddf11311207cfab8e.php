...
<?php $__env->startSection('main'); ?>
                                        ...
                                        <div class="box">
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                      <div class="input-row">
                                                        <input type="text" name="seller_name" id="seller_name" class="input-field" value="" placeholder="ENTER FULL NAME"  /> <?php echo $errors->has('seller_name')? '<p class="help-block"style="color:red;">Please enter your full name</p>':''; ?>
 ...
 <?php echo $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter your Email Id</p>':''; ?>
                                                    ...
                                                    <div class="input-row">
                                                        <input type="tel" name="seller_phone" id="seller_phone" class="input-field" value="" placeholder="MOBILE NO"  /> <?php echo $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter your phone no.</p>':''; ?>

                                                    </div>
<div class="custom-file-upload input-row"><span class="box-heading" > UPLOAD PROJECT</span>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/beta/resources/views/theme/freeevaluation.blade.php ENDPATH**/ ?>