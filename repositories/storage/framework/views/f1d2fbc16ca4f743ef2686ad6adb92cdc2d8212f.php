        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <?php if( ! empty($title)): ?>
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> <?php echo e($title); ?>  <a href="<?php echo e(route('add_superadministrator')); ?>" class="btn btn-info pull-right"><i class="fa fa-user-plus"></i> Add Super Admin</a> </h1>
                        </div> <!-- /.col-lg-12 -->
                    </div> <!-- /.row -->
                <?php endif; ?>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/admin/add_superadministrator.blade.php ENDPATH**/ ?>