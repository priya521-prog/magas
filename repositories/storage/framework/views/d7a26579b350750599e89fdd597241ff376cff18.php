...
.innerListingbody ul li {
	...
	<!--<div class="buttonrightpart" style="float:right;margin-top:-12px">		<a href="<?php echo e(route('create_your_whitepaper')); ?>" class="postbutton">POST A WHITEPAPER</a></div>-->
	<?php
...
<br>			    <div class="row">
      ...
      <!--                                              <a href="<?php echo e(route('single_ad', [$ad->id, $ad->slug])); ?>">-->
						...
						<!--	<h2><?php echo e($ad->slug); ?></h2>-->
								<!--<?php echo shortDescription($ad->description);?><br>-->
								<!--<span>	<?php echo e($ad->created_at); ?></span><br>-->
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/magas21/public_html/resources/views/whitepaper.blade.php ENDPATH**/ ?>