...
?>
				...
				<div class="innerListingbody">
						...
						<div >
						<span class="innerheading blue" > PRO</span>
						</div>
...
<?php if($ads->count() > 0): ?>
					...
					<div class="topdetailintoprt" id="mobilecustomcss" style=" float: left;margin-bottom: 100px;">
<div >
							<?php if ($ad->business_image== "") { ?>
									<a href="<?php echo e(route('single_ad', [$ad->id, $ad->slug])); ?>"><img src="<?php echo url('/');?>/uploads/placeholder.png" style="width:160px;" class="img-circle"></a>
									<?php } else { ?>
									<a href="<?php echo e(route('single_ad', [$ad->id, $ad->slug])); ?>"><img src="<?php echo url('/');?>/uploads/businesslogo/<?php echo $ad->business_image;?>" style="width:160px;" class="img-circle"></a>
									<?php } ?>
						</div>
 <div class="clearfix"></div>
						<div class="profinto" style="margin-top: 30px;">
							<h2><a href="<?php echo e(route('single_ad', [$ad->id, $ad->slug])); ?>"><?php echo e($ad->seller_name); ?></a> </h2>
							<h3><?php echo e($ad->designation); ?></h3>
							

<span>
									<i class="fa fa-map-marker"></i>
		<?php if($ad->state_name): ?> <?php echo e($ad->state->state_name); ?>    <?php endif; ?>  <?php echo e($ad->country->country_name); ?>
						...
						<div class="socialinto">
							<span style="margin-bottom: -65px;margin-left: 20px;">
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/beta/resources/views/theme/modern/pro.blade.php ENDPATH**/ ?>