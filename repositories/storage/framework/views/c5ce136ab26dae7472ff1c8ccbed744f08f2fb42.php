                                  ...
                                  <div class="box-left">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4">
                                             ...
                                             <p><b>INVOICE #: </b><?php echo $data->payment_id; ?></p>
                                
 <p><b>NAME:</b> <?php echo $data->name; ?></p>
  <p><B>LOCATION:</B> <?php echo $data->address; ?></p>
                                                       <p><B>PURCHASE ORDER:</B> <?php echo $data->invoiceId; ?></p>
                                                       <p><b>Affiliate Code:</b> <?php echo $data->utilized_code; ?></p>
                                        </div>
                                         <div class="col-md-4">
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/admin/thankyou.blade.php ENDPATH**/ ?>