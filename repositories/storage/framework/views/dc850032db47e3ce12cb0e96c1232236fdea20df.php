                                ...
                                <?php $__currentLoopData = $ads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!--<a href="<?php echo e(route('edit_ad1',[$ad->id] )); ?>" class="btn btn-primary"><i class="fa fa-edit"></i> </a>-->
                                            <a href="<?php echo e(route('delete_ads')); ?>" class="btn btn-danger deleteAds" data-slug="<?php echo e($ad->slug); ?>"><i class="fa fa-trash"></i> </a>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/admin/my_ads.blade.php ENDPATH**/ ?>