...
<?php if($ads->count() > 0): ?>
						...
						<div class="profinto">
					<h2>
                            <a href="<?php echo e(route('classifieds', ['user_id'=>$ad->user_id])); ?>" style="font-size: 15px !important;"> <?php echo e($ad->seller_name); ?></a></h2>
						...
						<div class="socialinto" style="margin-top: 20px;">
							<span>
...
<div class="profinto" style="margin-bottom:20px;">
	<h2><a href="<?php echo e(route('single_ad', [$ad->id, $ad->slug])); ?>" style="font-size: 15px !important;"><?php echo e($ad->title); ?> </a></h2>	
...
<?php if($ads->count() > 0): ?>
						...
						<div class="profinto">
					<h2>
                            <a href="<?php echo e(route('single_ad', [$ad->id, $ad->slug])); ?>" style="font-size: 15px !important;"> <?php echo e($ad->seller_name); ?></a></h2>
							<h3 style="font-size: 15px !important;"><?php  echo ucwords($ad->sub_category->category_name);?></h3>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/magas21/public_html/resources/views/classifieds.blade.php ENDPATH**/ ?>