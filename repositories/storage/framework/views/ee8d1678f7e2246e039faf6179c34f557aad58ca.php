						     ...
						     <div class="custom-file-upload input-row">
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="ad_title" id="" class="input-field" value="" placeholder="HEADING"  />
...
<div class="custom-file-upload input-row"><span class="box-heading" > COMPANY BROCHURE</span>
 ...
 <div class="input-row"> 
	<input type="text" class="form-control" id="address" value="" name="address" placeholder="LOCATION">
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/beta/resources/views/theme/createprojects.blade.php ENDPATH**/ ?>