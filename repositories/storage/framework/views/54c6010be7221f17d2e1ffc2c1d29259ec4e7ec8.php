        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <?php if( ! empty($title)): ?>
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> <?php echo e($title); ?> <a href="<?php echo e(route('create_new_page')); ?>" class="btn btn-info pull-right"> <i class="fa fa-floppy-o"></i> <?php echo app('translator')->get('app.create_new_page'); ?></a>
                            </h1>
                        </div> <!-- /.col-lg-12 -->
                    </div> <!-- /.row -->
                <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form action="" id="createPageForm" class="form-horizontal" enctype="multipart/form-data" method="post"> <?php echo csrf_field(); ?>

                        <div class="form-group <?php echo e($errors->has('title')? 'has-error':''); ?>">
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="title" value="<?php echo e(old('title')?old('title'): $page->title); ?>" name="title" placeholder="<?php echo app('translator')->get('app.title'); ?>">
...
<div class="form-group <?php echo e($errors->has('images')? 'has-error':''); ?>">
                        ...
                        <div class="form-group">
                            <div class="col-sm-9">
                                <button type="submit" class="btn btn-primary"><?php echo app('translator')->get('app.update_page'); ?></button>
                            </div>
                        </div>
                        </form>
...
<script>
        $(document).ready(function() {
            $("#images").change(function () {
                var fd = new FormData(document.querySelector("form#createPageForm"));
                $.ajax({
                    url: '<?php echo e(route('upload_page_image')); ?>',
                    type: "POST",
                    data: fd,
                    ...
                    success: function (data) {
                        ...
                        if (data.success == 1) {
                            $('#uploaded-ads-image-wrap').load('<?php echo e(route('append_page_media_image')); ?>');
                        } else {
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/beta/resources/views/admin/edit_page.blade.php ENDPATH**/ ?>