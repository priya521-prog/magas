...
<br>			    <div class="row">
					...
					<?php if ($ad->business_image== "") { ?>
						...
						<p style="font-size:10px;text-transform: capitalize;">
							...
							<p style="font-size:10px"><?php echo e($ad->designation); ?> </p>
...
<br>			    <div class="row">
					...
					<?php if ($ad->business_image== "") { ?>
						...
						<span >	
						<p style="font-size:10px;text-transform: capitalize;">
						    <a href="<?php echo e(route('user.create')); ?>"><?php echo e($ad->seller_name); ?></a> </p>
							<p style="font-size:10px"><?php echo e($ad->designation); ?> </p>
			              ...
			              <div class="col-md-6">
							...
							<span style="font-size:12px">
                            <?php echo shortDescription($ad->description);?><br/><br/> 
                            <a href="<?php echo e(route('user.create')); ?>" class="btn theme-btn"  style="background-color:#191a50;"> VIEW </a> 
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/theme/modern/pro.blade.php ENDPATH**/ ?>