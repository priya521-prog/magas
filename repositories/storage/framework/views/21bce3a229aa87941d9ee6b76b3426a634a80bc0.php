...
<?php if($lUser->account_type == 'premiumplan') { ?>
					<?php if($paymentmade=="paid") { ?>
					 <li> <a href="<?php echo e(route('user_messages')); ?>" id="changecolor">My Inbox</a> </li>
				
          
 <li>  <a href="<?php echo e(route('user_approvedads')); ?>" id="changecolor"><?php echo app('translator')->get('app.approved_ads'); ?></a> </li>
             <li>  <a href="<?php echo e(route('pending_ads')); ?>" id="changecolor"><?php echo app('translator')->get('app.pending_for_approval'); ?></a> </li>
             <li>  <a href="<?php echo e(route('user_blocked_ads')); ?>" id="changecolor" ><?php echo app('translator')->get('app.blocked_ads'); ?></a> </li>
                <!--<li> <a href="<?php echo e(route('initiatebizzPayments')); ?>" id="changecolor">Buy Bizz</a> </li>-->
                 <li>
   ...
   ?>
    ...
    <?php
             ...
             <li>
                ...
                <ul class="nav nav-second-level">
                    <li>  <a href="<?php echo e(route('projects')); ?>" id="changecolor" >Opportunities</a> </li>
                    <li>  <a href="<?php echo e(route('createprojects')); ?>" id="changecolor"> Create Opportunities Listing</a> </li>
                </ul>
            </li>
                   <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>  <a href="#" id="changecolor" ><?php echo app('translator')->get('app.posts'); ?></a> </li>
                    <li>  <a href="#" id="changecolor" ><?php echo app('translator')->get('app.create_new_post'); ?></a> </li>
                    <li>  <a href="#" id="changecolor">Save ad as favorite</a> </li>
                </ul>
            </li>
            <li>
            ...
            <li><a href="<?php echo e(route('code_utilize')); ?>" id="changecolor" >Utilized Code</a></li>
...
?>
            ...
            <!--<li> <a href="<?php echo e(route('admin_brands')); ?>" id="changecolor"><i class="fa fa-adjust"></i> Services</a>  </li>-->
             <li> <a href="<?php echo e(route('contact_messages')); ?>" id="changecolor"><i class="fa fa-envelope-o"></i> My Inbox</a>  </li>
            <li>
                <a href="#" id="changecolor"><i class="fa fa-bullhorn"></i> <?php echo app('translator')->get('app.ads'); ?><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse in" aria-expanded="true" style="">
                    <li>  <a href="<?php echo e(route('my_ads')); ?>" id="changecolor" >My Ads</a> </li>
                    <!--<li>  <a href="<?php echo e(route('approved_ads')); ?>" id="changecolor"><?php echo app('translator')->get('app.approved_ads'); ?></a> </li>-->
                     <li>  <a href="<?php echo e(route('approved_ads')); ?>" id="changecolor"><?php echo app('translator')->get('app.approved_ads'); ?></a> </li>
 ...
 <li><a href="<?php echo e(route('profile1')); ?>" id="changecolor" >PDF Report</a></li>
          
            <li> <a href="<?php echo e(route('fetch_user')); ?>" id="changecolor">Assign Affilate Code</a> </li>
                <li> <a href="<?php echo e(route('code_report')); ?>" id="changecolor">Affilate Code Report</a> </li>

                   <li> <a href="<?php echo e(route('add_logo')); ?>" id="changecolor">Add Logos</a> </li>
              <li> <a href="<?php echo e(route('premium_status')); ?>" id="changecolor">Upgrade to Premium</a> </li>
              
               <li> <a href="<?php echo e(route('fetch_bizz')); ?>" id="changecolor">Set Bizz Expiry </a> </li>
                <li> <a href="<?php echo e(route('assign_aduser')); ?>" id="changecolor">Assign Ads to users  </a> </li>
             <li> <a href="<?php echo e(route('parent_categories')); ?>" id="changecolor"><i class="fa fa-list"></i> Industries</a>  </li>
            <li> <a href="<?php echo e(route('admin_brands')); ?>" id="changecolor"><i class="fa fa-adjust"></i> Services</a>  </li>
            
            <!--<li> <a href="<?php echo e(route('inmailSearch')); ?>" id="changecolor"><i class="fa fa-envelope-o"></i>In-mail</a>  </li>-->
             <!--<li> <a href="<?php echo e(route('add_superadministrator')); ?>"><i class="fa fa-users"></i> Add Super Admin</a>  </li>-->
           <!--    <li> <a href="<?php echo e(route('administrators')); ?>"><i class="fa fa-users"></i> <?php echo app('translator')->get('app.administrators'); ?></a>  </li>-->
...
<?php /**PATH /home/magas21/public_html/resources/views/admin/sidebar_menu.blade.php ENDPATH**/ ?>