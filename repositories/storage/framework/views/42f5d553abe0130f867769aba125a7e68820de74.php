                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="form-group <?php echo e($errors->has('title')? 'has-error':''); ?>">
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="title" value="<?php echo e(old('title')?old('title'): $post->title); ?>" name="title" placeholder="<?php echo app('translator')->get('app.title'); ?>">
                        ...
                        <div class="form-group <?php echo e($errors->has('post_content')? 'has-error':''); ?>">
                            <div class="col-sm-12">
                                <textarea name="post_content" id="post_content" class="form-control"><?php echo old('post_content')? old('post_content'): $post->post_content; ?></textarea>
                        ...
                        <div class="form-group <?php echo e($errors->has('images')? 'has-error':''); ?>">
                            <div class="col-sm-12">
                                ...
                                <p class="text-info"><?php echo app('translator')->get('app.post_img_resize_info'); ?></p>
                        ...
                        <div class="form-group">
                            <div class="col-sm-9">
                                <button type="submit" class="btn btn-primary"><?php echo app('translator')->get('app.update_post'); ?></button>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/admin/edit_post.blade.php ENDPATH**/ ?>