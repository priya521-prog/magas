	...
	<div class="main">
		<div class="custom-container">
			<div class="listingbody">
                            ...
                            <?php if($ad->category): ?>
                            <li><a href="<?php echo e(route('projects', ['category' => $ad->category->id])); ?>"> <?php  echo ucwords($ad->sub_category->category_name);?> </a> </li>
                            <?php endif; ?>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/beta/resources/views/theme/modern/opportunities_ad.blade.php ENDPATH**/ ?>