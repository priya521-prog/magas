...
<?php } ?>   
      ...
      <td><?php echo e($message->fullpageurl); ?></td>
             ...
             <!--<td><a href="<?php echo e(route('deletecontact',[$message->id])); ?>">Delete</a></td>-->
               ...
               <td><a href="<?php echo e(route('deleteusermessage',[$message->id])); ?>">Delete</a></td>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/admin/user_contactmessages.blade.php ENDPATH**/ ?>