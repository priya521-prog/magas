						     ...
						     <div class="custom-file-upload input-row">
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="ad_title" id="" class="input-field"  value="" placeholder="HEADING"  required/>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/theme/create_bizzad.blade.php ENDPATH**/ ?>