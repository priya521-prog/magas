  ...
  <div class="main">
            <div class="custom-container">
                ...
                <?php echo $__env->make('admin.flash_msg', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <div class="row">
                            <div class="col-sm-12">
                        <form action="/pro/edit/<?php echo e($ads->id); ?>" id="profileadsPostForm" class="form-horizontal" enctype="multipart/form-data" method="post"> <?php echo csrf_field(); ?>
                                <div class="form-tabs">
                                    <ul>
                                        ...
                                        <div class="box">
                                            <div class="add-images">
                                                <div class="custom-file-upload input-row">
                                                        PROFILE IMAGE (Recommended 250*250)<br/>
...
<?php echo $errors->has('filescustommedia')? '<p class="help-block" style="color:red;">Please Upload your profile picture. </p>':''; ?>
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                    <div class="input-row">
                                                        <input type="text" name="ad_title" id="" class="input-field" value="<?php echo e($ads->title); ?>" placeholder="FULL NAME"  />
<?php echo $errors->has('ad_title')? '<p class="help-block" style="color:red;">Please enter your full name. </p>':''; ?>

                                                    </div>
 <div class="input-row">
                                                        <input type="text" name="designation" id="" class="input-field" value="<?php echo e($ads->designation); ?>" placeholder="DESIGNATION"  />
...
<div class="custom-file-upload input-row">
		<span class="box-heading" > Upload CV</span><br>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/theme/edit_pro.blade.php ENDPATH**/ ?>