...
<div class="body alacarte">

            <div class="main">
                <div class="section alacarte-content" style="margin-bottom: 228px;">
                    <div class="tabpanel">
                        <div class="custom-container">
                            <div class="alacarte-menu" style="margin-top: 30px;">
                                ...
                                <div class="title">
                                    ...
                                    <ul>
                                            <li class="each-form-tabh active">
                                                 <a style="color:#fff;" href="<?php echo e(route('packages')); ?>" style="cursor: pointer;">
                                                     <div class="curved-buttonss">
                                                    ALA CARTE
                                                    </div>
                                                 </a>
                                           </li>
                                     
                                        <li class="each-form-tabh">
                                ...
                                <div class="tabpanel">
                                    <ul>
                                        ...
                                        <li class="each-form-tab" onclick="showTab('cs-tab', 'cs-content');">
                                            <div class="curved-buttons">
                                                Corporate Services
                                            </div>
                                        </li>
                                        <li class="each-form-tab" onclick="showTab('capital-tab', 'capital-content');">
                                            <div class="curved-buttons">
                                                Capital
                                            </div>
                                        </li>
                                        <li class="each-form-tab" onclick="showTab('technology-tab', 'technology-content');">
                                            <div class="curved-buttons">
                                                Technology
                                            </div>
                                        </li>
                                        ...
                                        <li class="each-form-tab">
                                            <div class="curved-buttons">
                                                 <a style="color:#fff" href="<?php echo e(route('contact_us_page')); ?>" style="cursor: pointer;">
                                            Contact
                                        </a>
                                            </div>
                                        </li>
                            ...
                            <div class="box">
                                <div class="advisory-content tab">
                                    <div class="left">
                                        <div class="bg-white">
                                            <div class="text">
                                            ...
                                            <ul>
                                                ...
                                                <li><a data-toggle="tab" href="#advisory">Business Advisory</a></li>
                                                <li><a data-toggle="tab" href="#plan">Business Plan Writing</a></li>
                                                <li><a data-toggle="tab" href="#structure">Brand Consultancy</a></li>
                                                <li><a data-toggle="tab" href="#tax">Tax Consultancy</a></li>
                                                <li><a data-toggle="tab" href="#feasibi">Feasibility Studies</a></li>
                                                <li><a data-toggle="tab" href="#manage">Management Consultancy</a></li>
                                                <li><a data-toggle="tab" href="#strategic">Strategic Alliance</a></li>
                                            </ul>
                                    ...
                                    <div class="right" >
                                         ...
                                         <div class="tab-content">
                                            ...
                                            <ul>
                                                ...
                                                <li>Business Formation and Setup</li>
                                                <li>Business Valuations</li>
                                                <li>Brand Consultancy</li>
                                                <li>Management Consultancy</li>
                                                <li>Succession planning (specifically for family-run businesses)</li>
                                                <li>Tax Consultancy</li>
                                                <li>Feasibility Studies and Research</li>
...
<!--Investors demand a business plan that assists them with an understanding of the solidity, functionality and risk managing modules of your business. Business valuation is then taken into consideration by the investors to study the business plan. Hence, it is essential to consider the business planning strategy for the investors to examine your stability and growth better.</li>-->
                                           ...
                                           <ul>
                                               <li>Getting the right name and purpose to your brand</li>
                                               <li>Brand Positioning</li>
                                               <li>Brand Competitor Research and Analysis</li>
                                               <li>Brand Refresh or Rebrand Strategy</li>
                                           </ul> 
                                           </div>
                                           ...
                                           <ul>
                                              <li> Due Diligence accession</li>
                                              <li>Tax-effective positioning and structuring for start-ups and SME’s</li>
                                                <li>Commercial Tax Planning</li>
                                                <li>Corporate Tax Planning</li>
                                                <li>Tax-effective distributions</li>
                                                <li>Business succession planning and structuring</li>
                                                <li>Off-shore and On-shore Tax planning and Structuring</li>
                                                <li>Year-end Tax planning</li>
                                                <li>VAT filing and registration</li>
                                    	   ...
                                    	   <div class="title"> FEASIBILITY STUDIES
</div>
                                           <div class="text"> 
                                           The components of Feasibility Studies include
                                           </div>
                                           <ul>
                                              <li>Market feasibility-
                                                Do you see the potential market that is willing to know your business?</li>
                                                 <li>Economic feasibility-
                                                What role does economic factors play in your business?</li>
                                                 <li>Financial feasibility-
                                                Is your business ready for investments and returns?</li>
                                                 <li>Operational feasibility-
                                                Are your internal resources stabilized?</li>
                                                 <li>Technical feasibility-
                                                Is your business ready for the target market?</li>
                                                 <li>Competitive feasibility-
                                                Would the competitive market accept your business?</li>

                                           </ul> 

                                    	    </div>
                                    	     <div id="manage" class="tab-pane fade">
                                    	   <div class="title"> MANAGEMENT CONSULTANCY
</div>
                                           <div class="text"> 
                                           Our Management Consulting and Business Advisory Services offer the following assistance
                                           </div>
                                           <ul>
                                            <li> Guidance in implementing various techniques for raising the business revenue and profit</li>
                                            <li>Analysis on supplier arrangements in order to shrink the costs</li>
                                            <li>Business planning and strategy to recognize the business goal</li>
                                            <li>Evaluating the market to develop various effective marketing motions</li>
                                            <li>Amplifying business’s pricing strategy and module</li>
                                            <li>Assessing and promoting the products and services</li>
                                            <li>KPI tracking and measuring the impact accordingly</li>

                                           </ul> 

                                    	    </div>
                                    	       <div id="strategic" class="tab-pane fade">
                                    	   <div class="title"> STRATEGIC ALLIANCE
</div>
                                           <div class="text"> 
                                           At MAGAS, the key elements to a Joint Venture or a strategic Alliance are
                                           </div>
                                           <ul>
                                            <li> Evaluating the parties being involved</li>
                                            <li>Considering the operational scope of a Joint venture arrangement</li>
                                            <li>Assessing the workflow and contribution of each party</li>
                                            <li>Legal regulations</li>
                                            <li>Drafting the mandates (after deal completion)</li>
                                        ...
                                        <div class="bg-white">
                                            <div class="each-row">
                                                <div class="list1">
                                                    ...
                                                    <ul>
                                                        <li><a href="#vat" data-toggle="tab">VAT Services</a></li>
                                                        <li><a href="#business" data-toggle="tab">Business Preparation for VAT</a></li>
                                                        <li><a href="#finance" data-toggle="tab">Financial Accounting for VAT</a></li>
                                                        <li><a href="#kpi" data-toggle="tab">KPI Monitoring</a></li>
                                                        <li><a href="#book" data-toggle="tab">Bookkeeping</a></li>
                                                        <li><a href="#cashflow" data-toggle="tab">Cashflow Management</a></li>
                                                        <li><a href="#payroll" data-toggle="tab">Payroll Accounting</a></li>
                                                    </ul>
                                                </div>
                                                <div class="list2">
                                                    <div class="title">
                                                    ...
                                                    <ul>
                                                        <li><a href="#forensic_audit" data-toggle="tab">Forensic Audit</a></li>
                                                        <li><a href="#internal_audit" data-toggle="tab">Internal Audit</a></li>
                                                        <li><a href="#iso_audit" data-toggle="tab">ISO Audit</a></li>
                                                        <li><a href="#spec_audit" data-toggle="tab">Special Audit</a></li>
                                                        <li><a href="#stat_audit" data-toggle="tab">Statutory Audit</a></li>
                                                        <li><a href="#tax_audit" data-toggle="tab">Tax Audit</a></li>
                                                    </ul>
                                                </div> 
                                                <div class="clearfix"></div>
                                            </div>
                                            <div class="each-row">
                                                <div class="list1">
                                                    ...
                                                    <ul>
                                                        <li><a href="#asset" data-toggle="tab">Asset Management</a></li>
                                                        <li><a href="#corporate" data-toggle="tab">Corporate Governance</a></li>
                                                        <li><a href="#cost" data-toggle="tab">Cost Control & Restructuring</a></li>
                                                        <li><a href="#perform" data-toggle="tab">Performance Management</a></li>
                                                        <li><a href="#project" data-toggle="tab">Project Management</a></li>
                                                    </ul>
                                                </div>
                                                <div class="list2">
                                                    <div class="title">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="#commercial" data-toggle="tab">Commercial Contracts</a></li>
                                                        <li><a href="#corporate" data-toggle="tab">Corporate Structuring</a></li>
                                                        <li><a href="#dispute" data-toggle="tab">Dispute Mediation</a></li>
                                                        <li><a href="#will" data-toggle="tab">Will Writing Services</a></li>
                                                    </ul>
                                                </div> 
                                                <div class="clearfix"></div>
                                            </div>
                                            <div class="each-row">
                                                <div class="list1">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="#contract" data-toggle="tab">Contract Workers</a></li>
                                                        <li><a href="#executive" data-toggle="tab">Executive Search</a></li>
                                                        <li><a href="#manpower" data-toggle="tab">Manpower Supply</a></li>
                                                    </ul>
                                                </div>
                                                <div class="list2">
                                                    <div class="title">
                                                    ...
                                                    <ul>
                                                        <li><a href="#brand" data-toggle="tab">Branding & Product Placements</a></li>
                                                        <li><a href="#content" data-toggle="tab">Content Marketing</a></li>
                                                        <li><a href="#digital" data-toggle="tab">Digital Marketing</a></li>
                                                        <li><a href="#outdoor" data-toggle="tab">Outdoor Advertising</a></li>
                                                        <li><a href="#market" data-toggle="tab">Market Research</a></li>
                                                    </ul>
                                                </div> 
                                                <div class="clearfix"></div>
                                            </div>
                       ...
                       <div class="tab-content">
                             <div class="tab-pane fade in active">
                                            ...
                                            <!--</div>-->
                                            <!--<div class="text">-->
                                            <!--    Accounting is a sensitive asset and to leave you with zero worries — we have skilled our practice on diligent communication and cooperation, discerning that we need to be flexible and creative to meet your individual needs. MAGAS aims to personalize the accounting services as per your business needs and this is achieved with a maximised use of technology tools. Our focus lies in delivering our professional services to a wide range of clients from a multiple category of industries.-->
                                            <!--</div>-->
                                            <!--<div class="text">-->
                                            <!--    We help build your business objectives with our variety of accounting services…-->
                                            <!--</div>-->
                                            <!--<ul>-->
                                            <!--    <li>Taxation Services</li>-->
                                            <!--    <li>Business Preparation for VAT</li>-->
                                            <!--    <li>Financial Accounting for VAT</li>-->
...
At MAGAS, our specialists will draft the financial structure of your business and perform a session to train your staff on the procedure of VAT implementation. This serves as an important act for your workforce to understand and implement the necessary changes needed in their designated tools. Based on the impact evaluation, we will execute a road-map for bringing forth the changes needed, discerning the requirements scheduled and more.</li>
                                           ...
                                           <ul>
                                               <li>Value-Added Tax (VAT) is a tax added to the cost of a product or service and is levied for purposes of generating revenue for the government. This, in simple term refers to the sellers who collect the tax from their customers and pay it on to the state.</li>
                                               <li>The state of being legally obliged and responsible to pay VAT, concerns anyone who sells goods, services, rents out goods, or is engaged in similar trading operations in the conduct of business.</li>
                                               <li>The main reason to VAT being introduced in the Middle East is to help governments deliver on long-standing plans for economic variegation away from oil, while still being able to deliver social and economic programs.</li>
                                          ...
                                          Bookkeeping companies grasp different facets of an organization’s financial conditions. Bookkeepers manage the day-to-day monetary management and accountants propound valuable discernment into the business’ financial strategic planning. 
                                           ...
                                           <div class="text">Hence, if you decide to grow your business to a certain point where you need to bring a bookkeeper along with an accountant onsite to manage different tasks for your company, you will need to have a few pointers noted. Let MAGAS introduce you to them</div>
                                           <ul>
                                              <li>The amount of knowledge and experience the bookkeeping services and the accounting firms in Dubai hold.</li>
                                                 <li>The range of services that the firm can offer.</li>
                                                 <li>Get to know their communication skills because they need to simplify things and will have to keep you updated on your business’s financial status.</li>
                                                 <li>Make sure to choose from the right tax consultants in Dubai. They will have to be your sidekick so you do not have to worry about tax deadlines, refunds, and deductions.</li>
                                                 
                                           </ul> 

                                    	    </div>
                                    	     <div id="cashflow" class="tab-pane fade">
                                    	   <div class="title"> CASHFLOW MANAGEMENT 
</div>
                                           <div class="text"> 
                                           ...
                                           <ul>
                                            ...
                                            <li>Key Performance Indicators (KPI) Monitoring</li>
                                            <li>Banking Structure</li>
                                            <li>Finance Metrics</li>
                                            <li>Management Accounting</li>
                                    	   ...
                                    	   <div class="title"> PAYROLL ACCOUNTING
</div>
                                           <div class="text"> 
                                           ...
                                           <ul>
                                            <li>Business Valuation for buying and selling</li>
                                            <li>Budgeting & Forecasting</li>
                                            <li>Management Accounting</li>
                                            <li>Performance Monitoring</li>
                                            <li>Business Health Assessments</li>
                                            <!--<li>Assessing the management of the deal</li>-->
                                    	   ...
                                    	   <div class="title"> FORENSIC AUDIT
</div>
                                           <div class="text"> 
                                           ...
                                           <ul>
                                            <li>A focus on studying and understanding your business activities</li>
                                            <li>We focus on risks generated by business activities</li>
                                            <li>Constant, timely and appropriate dialogue</li>
                                            <li>Our structure depends on the scope of work of your business.</li>
                                    	   ...
                                    	   <div class="title"> INTERNAL AUDIT
</div>
                                           <div class="text"> 
                                          Internal Audit includes Monitoring, analyzing and assessing the risks and controls of an organization.
                                           ...
                                           <ul>
                                            <li>A focus on studying and understanding your business activities</li>
                                            <li>We focus on the risks generated by business activities</li>
                                            <li>Constant, timely and appropriate dialogue</li>
                                            <li>Focus internal audit resources on areas critical to the success of the organization</li>
                                            <li>Meet all professional standards and requirements</li>
                                            <li>Provide stakeholders and managers with assurances that their key systems and controls are in place and working effectively</li>
                                            <li>Allow in-house resources to be used more effectively</li>
                                            <li>Provide dedicated internal audit professionals without the day to day managerial requirements</li>
                                            <li>Monitor key areas of the client's organization</li>
                                            <li>Provide clients with access to experts on various subjects</li>
                                            <li>Provide clear opinions linked back to the risk profile</li>

                                           </ul> 

                                    	    </div>
                                    	      <div id="iso_audit" class="tab-pane fade">
                                    	   <div class="title"> ISO AUDIT
</div>
                                           <div class="text"> 
                                      ...
                                      Special Audit has been conceived in the Auditing industry to focus mainly on a specific sector of a business’s acts. MAGAS provides the following types of special audits
                                        ...
                                        <li>Constant, timely and appropriate dialogue</li>
                                    	   ...
                                    	   <div class="title"> STATUTORY AUDIT
</div>
                                           <div class="text"> 
                                      Like any other Audit service, Statutory Audit serves the same purpose of determining the accurate characterization of a business’s financial situation by inspecting the financial database such as Transactions, Bookkeeping records, and Bank balances.
                                           ...
                                           <ul>
                                          <li>A focus on studying and understanding your business activities
</li>
                                        <li>We focus on risks generated by business activities
</li>
                                        <li>Constant, timely and appropriate dialogue</li>
                                      ...
                                      MAGAS consists of a taxation team that has attained years of experience across various industries and businesses including start-ups and large groups, private and public sectors, off-shore and on-shore zones, and more.
                                        ...
                                        <li>Taxation solutions</li>
                                    	   ...
                                    	   <div class="title"> ASSET MANAGEMENT
</div>
                                           <div class="text"> 
                                     Asset management falls under two main corporate services subject – Advisory services and Corporate Finance. At MAGAS, we serve for both the purposes.
                                        ...
                                        <li>Examining asset financing choices</li>
                                        <li>Statistical analysis of businesses</li>
                                        <li>Brief analysis on market and trends</li>
                                        <li>Account methods</li>
                                        <li>Productions operation management</li>
                                    	   ...
                                    	   <div class="title"> CORPORATE GOVERNANCE
</div>
                                           <div class="text"> 
                                     Under the corporate finance roof, MAGAS shadows Corporate Governance as an impetus to encourage effectual, entrepreneurial and advisable management that aims to stretch the success of a business for a long-term.
                                       ...
                                       MAGAS’s corporate governance specialists work with the board of directors to content your business’s compliance and regulatory needs. Our experts will save the valuable time for you to stay focused on your strategy while they work on improving your performance.
                                           ...
                                           <ul>
                                          <li>Auditing your current governance system and operations;</li>
                                        <li>Establishing and putting forth a constructive corporate governance structure;</li>
                                        <li>Elaborating policies, charters, and processes to assist compliance; and</li>
                                        <li>Developing and executing board and management governance training.</li>
                                    	   ...
                                    	   <div class="title"> COST CONTROL AND RESTRUCTURING
</div>
                                           <div class="text"> 
                                     At MAGAS, our strongest feature in corporate finance services is Cost Management. It acts as a merit to our ship of financial services in order to support your business by delivering the right cost management solutions on budget.
                                      ...
                                      Our Focus is YOUR BUSINESS
                                           ...
                                           <ul>
                                          <li>Your assets remain secured</li>
                                        <li>We suggest the most operative business modules</li>
                                        <li>Build a hassle-free environment</li>
                                        <li>Raise your cash flow</li>
                                        <li>Assurance of transparency</li>
                                  ...
                                  Performance management is an operational procedure of developing a professional environment or framework where individuals are sanctioned to the best of their capacity.
                                      ...
                                      Taking the United Arab Emirates (UAE) market into consideration, we have observed the various challenges that the CFO’s face in steering profitable growth for their business. Keeping the crucial factors in mind, MAGAS has developed corporate finance techniques that highlights its expertise on…
                                        ...
                                        <li>Financial Advisory</li>
                                    	   ...
                                    	   <div class="title"> PROJECT MANAGEMENT
</div>
                                           <div class="text"> 
                                    ...
                                    Our project management services include the following
                                        ...
                                        <li>Cost control and restructuring</li>
                                        <li>Cost-benefit and planning</li>
                                        <li>Risk analysis assessments</li>
                                        <li>Project planning</li>
                                        <li>Project programming</li>
                                        <li>Cost Analysis</li>
                                        ...
                                        <li>Quality management</li>
                                    	   ...
                                    	   <div class="title"> COMMERCIAL CONTRACTS
</div>
                                           <div class="text"> 
                                    ...
                                    MAGAS holds an experience into identifying and creating the following types of commercial contracts…
                                       ...
                                       <li> Confidentiality agreements</li>
                                        ...
                                        <li>Distribution and supply agreements</li>

                                           </ul> 

                                    	    </div>
                                    	      <div id="corporate" class="tab-pane fade">
                                    	   <div class="title"> CORPORATE STRUCTURING
</div>
                                           <div class="text"> 
                                   ...
                                   At MAGAS, our legal experts submit the corporate structuring proposal with confidence as they have gained years of experience in the MENA region and have studied the law thoroughly. We have the knowledge to make sure you understand the significance of your business by briefing you on what has happened, what is happening and what might happen. Our Corporate structuring Services consist of many benefits
                                           ...
                                           <ul>
                                        <li>Cost-effective and systematic composition of legal particulars on timely basis</li>
                                        <li>Providing appropriate and relevant information, business advice and guidance based on various factors</li>
                                        <li>Convenient access to perform a legal analysis</li>
                                        <li>Effective access to multiple services to support your business’s broader needs</li>

                                           </ul> 

                                    	    </div>
                                    	          <div id="dispute" class="tab-pane fade">
                                    	   <div class="title"> DISPUTE MEDIATION
</div>
                                           <div class="text"> 
                                   ...
                                   Most of the business disputes tend to stay longer and tend to misuse your business’s time and resources. Most of the legal disputes turn out to litigations. Litigation is the situation where if the dispute becomes major, it is taken further to the court or tribunal. There are two forms to deal with a business dispute
                                           ...
                                           <ul>
                                        <li>Alternative dispute resolution – dispute mediation, conciliation, arbitration</li>
                                        <li>External dispute resolution - industry ombudsman services</li>
                                    	   ...
                                    	   <div class="title"> WILL WRITING SERVICES
</div>
                                           <div class="text"> 
                                  ...
                                  Our legal writers have gained years of experience in many areas:
                                           ...
                                           <ul>
                                       <li>Commercial Law and Transactions</li>
                                        <li>Taxation</li>
                                        ...
                                        <li>Property law</li>
                                    	   ...
                                    	   <div class="title"> CONTRACT WORKERS
</div>
                                           <div class="text"> 
                                 ...
                                 There are multiple beneficial factors in recruiting contracted staff or temporary workers for your project.
                                           ...
                                           <ul>
                                       <li>Temporary or contracted workers serve as a chance for businesses to recruit staff with experience or to cushion a particular department for a short time.</li>
                                        <li>The contract workers with the right skills serve as a triggering part in any company.</li>
                                        <li>As their presence does not last long, they invest the best they can for your business to bloom in a short period of time.</li>
                                        <li>Having said this, your business can make the most of their skills without a need to train.</li>
                                    	   ...
                                    	   <div class="title"> EXECUTIVE SEARCH
</div>
                                           <div class="text"> 
                                 ...
                                 We begin the Executive Search by developing a clear understanding of a candidate’s profile, while also keeping in mind the culture and strategy of your concerned business. A good head-hunter will be sensitive towards the requirements of both - the candidate and the company while producing results. Our experts, with many years of human resources experience, are client-driven to find ‘people for jobs’, not ‘jobs for people’.
                                           ...
                                           <ul>
                                       <li>We deploy keeping the qualifications of a candidate as our first criteria. This helps us have a database of only the best professionals you need</li>
                                        <li>We reduce the lost production time by proffering an immediate access to the temporary staff</li>
                                        <li>We take into consideration your priorities and yet keep safety and standards in mind</li>
                                        <li>We save your costs and time in looking for the right candidates</li>
                                        <li>We offer consultancy access to industrial relations, if necessar</li>
                                    	   ...
                                    	   <div class="title"> MANPOWER SUPPLY
</div>
                                           <div class="text"> 
                                ...
                                With boundless talent network and industry-leading services, we let our clients focus on their job while we handle the buzz of bringing you the right talent. Allocate MAGAS as your Manpower supply partner and add value to your business in multiple ways…
                                       ...
                                       <li>We deploy keeping the qualifications of a candidate as our first criteria. This helps us have a database of only the best professionals you need</li>
                                        ...
                                        <li>We offer consultancy access to industrial relations, if necessar</li>
                                    	   ...
                                    	   <div class="title"> BRANDING AND PRODUCT PLACEMENTS
</div>
                                           <div class="text"> 
                              ...
                              Why Choose us?
                                       ...
                                       <li>Attention to details</li>
                                        <li>Creativity and a plan for success</li>
                                        <li>Professional Experts Only</li>
                                        ...
                                        <li>Meeting Deadlines</li>
                                    	   ...
                                    	   <div class="title"> CONTENT MARKETING 
</div>
                                           <div class="text"> 
                                ...
                                Content marketing strategy mainly includes:
                                           ...
                                           <ul>
                                     <li> A business perception to evaluate the future prospects</li>
                                    <li>Curation of potential purchasing identities</li>
                                    <li>Keyword strategy mainly utilizing the SEO operating model</li>
                                    <li>Understanding of the types of content based on the target audience</li>
                                    <li>Brand guideline to create the right content</li>
                                    <li>Briefing on the frequency, responsibilities and content calendar</li>
                                ...
                                We provide online and digital marketing services across United Arab Emirates and the MENA regions. At MAGAS, Online and Digital Marketing services in itself is a vast subject that caters in several ways
                                     ...
                                     <li> Social Media Marketing</li>
                                        ...
                                        <li>Mobile Marketing</li>
                                    	   ...
                                    	   <div class="title"> OUTDOOR ADVERTISING
</div>
                                           <div class="text"> 
                              ...
                              By utilizing outdoor advertising strategy, your business can
                                   ...
                                   <li>   Build brand awareness</li>
                                    <li>Promote the right target-oriented message</li>
                                    <li>Launch a brand cost-effectively</li>
                                    <li>Have an impact to mass audiences</li>
                                    <li>Promote at the right location cost-effectively</li>
                                    <li>Reinforce the brand awareness for a longer period</li>
                                    <li>Convert the awareness to purchasing behaviour</li>
                                    	   ...
                                    	   <div class="title"> MARKET RESEARCH
</div>
                                           <div class="text"> 
            ...
            <div class="capital-content tab">
            <div class="left" style="margin-bottom:100px;">
                ...
                <div class="bg-white">
                   <div class="each-row">
                        <div class="list1">
                            ...
                            <ul>
                                <li><a href="#val" data-toggle="tab">Business Valuation</a></li>
                                <li><a href="#exec" data-toggle="tab">Deals Execution</a></li>
                                <li><a href="#source" data-toggle="tab">Deal Sourcing</a></li>
                                <li><a href="#deal_struct" data-toggle="tab">Deal Structuring</a></li>
                                <li><a href="#due" data-toggle="tab">Due Diligence</a></li>
                                <li><a href="#merge" data-toggle="tab">Mergers & Acquisitions</a></li>
                                <li><a href="#sustain" data-toggle="tab">Sustainability Testing</a></li>
                                <li><a href="#sensitive" data-toggle="tab">Sensitivity  Testing and Analysis</a></li>
                            </ul>
                        </div>
                        <div class="list2">
                            <div class="title">
      ...
      <!--              </div>-->
      <!--              <div class="text">-->
      <!--                  it is important to know that a complete understanding of the value of your business is an important -->
						<!--factor. The study of this understanding will be beneficial in making decisions for the future of your business.  -->
						<!--<br/>-->
						<!--Business Value = (Revenue attained - Expenses spent) * Growth achieved - Risk taken)  -->
						<!--<br/>-->
      ...
      <!--                  </div>-->
      <!--                  <ul>-->
      <!--                      <li>Internal sales of valuation</li>-->
      <!--                      <li>Value Participation</li>-->
      <!--                      <li>Restructure of busines body</li>-->
      <!--                      <li>Formation of Return on Investment analysis</li>-->
      <!--                      <li>Strategic business planning and writing</li>-->
      <!--                  </ul>-->
      <!--                  <div class="text">-->
      <!--                      MAGAS delivers expert advise in the sector of business valuation.We offer an-->
    		<!--				unconventional vigorous valuation process which aims to deliver a transparent understanding -->
...
Business Value = (Revenue attained – Expenses spent) x (Growth achieved – Risk taken)
                                            ...
                                            <ul>
                                                <li>Potential process of selling off subsidiary business interests or investments strategy</li>
                                                <li>Internal sales of valuation</li>
                                                <li>Value participation</li>
                                                <li>Restructure of business body</li>
                                                <li>Formation of Return on Investment analysis</li>
                                                <li>Strategic business planning and writing</li>
                                            </ul>
                                            <!--<div class="title">  </div>-->
                                    	...
                                    	<div id="exec" class="tab-pane fade">
                                          ...
                                          Due diligence is an analysis or audit of a potential investment to confirm all facts, such as evaluating the financial records, plus any deemed material. You can simply rely on us to be the right choice for such factors. Our experts offer a detailed analysis and due diligence reports that act as a very crucial part in forming key decisions and business consultations. MAGAS provides Due Diligence services that serves businesses for various purposes
                                    	   ...
                                    	   <div class="title"> MERGERS & ACQUISITIONS
</div>
                                           <div class="text"> 
                                          Mergers & Acquisitions is defined as unification or consolidation between two parties or assets using different types of capital transactions. At MAGAS, depending on the type of deal, we source the right capital transactions
                                    	   ...
                                    	   <div class="title"> SUSTAINABILITY TESTING
</div>
                                           <div class="text"> 
                                    	   ...
                                    	   <div class="title"> SENSITIVITY ANALYSIS
</div>
                                           <div class="text"> 
                                          Sensitivity Analysis is implemented to evaluate the project management and profitability forecasts. We’re the ideal platform to take this technique further for you.
                                    	   ...
                                    	   <div class="title"> FUND MANAGEMENT
</div>
                                           <div class="text"> 
...
<li>Incubator funding
                                ...
                                <div class="technology-content tab">
                                   ...
                                   <div class="left">
                                        <div class="bg-white">
                                            ...
                                            <ul>
                                                <li><a href="#crm" data-toggle="tab">CRM Solutions</a></li>
                                                <li><a href="#erp" data-toggle="tab">ERP Systems</a></li>
                                                <li><a href="#infra" data-toggle="tab">Infrastructure Solutions</a></li>
                                                <li><a href="#network" data-toggle="tab">Networking & Systems</a></li>
                                                <li><a href="#integ" data-toggle="tab">Integrations</a></li>
                                                <li><a href="#stores" data-toggle="tab">Storage Solutions</a></li>
                                            </ul>
                					    <div class="title">
                                            IT Services
                                        </div>
                                            <ul>
                                                <li><a href="#mobile" data-toggle="tab">Mobile app Development</a></li>
                                                <li><a href="#tech" data-toggle="tab">Tech Development</a></li>
                                                <li><a href="#web" data-toggle="tab">Web Development</a></li>
                                            </ul>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="right">
                                         <div class="tab-content">
                                            ...
                                            <div class="text">We test and compare among the best customer relationship management (CRM) software solution providers to assist you in choosing the right one to optimize your customer interaction.</div>
                                            <!--<div class="title">  </div>-->
                                            <!--<div class="text">   </div>-->
                                        </div>
...
multiple virtual servers on a single real server.
                                           ...
                                           <ul>
                                               <li>The Hardware. It consists of servers, computers, data centers, switches, hubs,
and routers, etc.</li>
                                               <li>The Software. It consists of Operating System, ERP, CRM and other
applications.</li>
                                               <li>The Network. It consists of network enablement, internet connectivity,
firewall, and security.</li>
...
people, technology, and information in order to stay ahead of the competition.
                                    	   ...
                                    	   <div class="title"> STORAGE SOLUTIONS
</div>
                                           <div class="text"> 
...
data excels in paperless data management.
                                    	   ...
                                    	   <div class="title"> MOBILE APP DEVELOPMENT
</div>
                                           <div class="text"> 
...
software.
                                    	   ...
                                    	   <div class="title"> TECH DEVELOPMENT
</div>
                                           <div class="text"> 
...
valves, and accessories. Tech Development serves oil and gas, marine, and mining industries in the worldwide.
                                    	   ...
                                    	   <div class="title"> WEB DEVELOPMENT
</div>
                                           <div class="text"> 
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/magas21/public_html/resources/views/theme/catalogue.blade.php ENDPATH**/ ?>