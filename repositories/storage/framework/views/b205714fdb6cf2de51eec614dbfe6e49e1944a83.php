...
<?php $__env->startSection('main'); ?>
	...
	<div class="main" >
        ...
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 col-xs-12">
                ...
                <div class="login">
                    <h3 class="authTitle">Login or <a href="<?php echo e(route('user.create')); ?>" class="authTitle"> Sign up</a></h3>
 ...
 <!--                                   <input type="checkbox"  name="remember_token" id="remember_token">Remember Me-->
 <!--                               </div>-->
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/theme/login.blade.php ENDPATH**/ ?>