...
<?php echo $errors->has('filescustommedia')? '<p class="help-block" style="color:red;">Please Upload your profile picture. </p>':''; ?>
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                    <div class="input-row">
                                                        <input type="text" name="ad_title" id="" class="input-field" value="" placeholder="FULL NAME"  />
<?php echo $errors->has('ad_title')? '<p class="help-block" style="color:red;">Please enter your full name. </p>':''; ?>

                                                    </div>
 <div class="input-row">
                                                        <input type="text" name="designation" id="" class="input-field" value="" placeholder="DESIGNATION"  />
...
<?php echo $errors->has('company_name')? '<p class="help-block" style="color:red;">Please enter your LinkedIn URL. </p>':''; ?>
 ...
 <?php echo $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email address.</p>':''; ?>
                                                    ...
                                                    <div class="input-row">
                                                        <input type="tel" name="seller_phone" id="seller_phone" class="input-field" value="" placeholder="MOBILE NO"  /> <?php echo $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter the phone no.</p>':''; ?>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/beta/resources/views/admin/create_proad.blade.php ENDPATH**/ ?>