 ...
 <?php //dd($user);
    ...
    //dd($login_id);
       $login_type=$login_user->user_type;
							   if($login_type=='admin'){
					           ?>
					         <a class="btn theme-btn" style="background-color:#191a50;" href="<?php echo e(route('editclassifieds', [$ad->id])); ?>">Edit </a>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/theme/modern/classifieds_adedit.blade.php ENDPATH**/ ?>