                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group <?php echo e($errors->has('email')? 'has-error':''); ?>">
                                 ...
                                 <div class="form-group">
                                    <label for="phone">Phone Number </label>
                                        ...
                                        <input type="number" class="form-control" id="contact" placeholder="Enter Phone Number" name="contact" value="" required="required" />
                                ...
                                <div class="form-group <?php echo e($errors->has('message')? 'has-error':''); ?>">
                                    ...
                                    <textarea name="message" id="message" class="form-control" required="required" placeholder="Please enter your feedback"><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\magas_services\resources\views/whitepaper_ad.blade.php ENDPATH**/ ?>