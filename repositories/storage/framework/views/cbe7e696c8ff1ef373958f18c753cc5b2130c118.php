...
<?php echo $errors->has('ad_title')? '<p class="help-block" style="color:red;">Please enter the Title of the ad. </p>':''; ?>
                                ...
                                <p class="text-info">  A description will help End users to know More about your Ad</p>
                                            ...
                                            <div class="box-right">
                                                ...
                                                <div class="sign-up-form">
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="seller_name" id="seller_name" class="input-field" value="" placeholder="ENTER FULL NAME"  /> <?php echo $errors->has('seller_name')? '<p class="help-block"style="color:red;">Please enter the name to be displayed on Ad.</p>':''; ?>
 ...
 <?php echo $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the Email Id to be displayed on Ad.</p>':''; ?>
                                                    ...
                                                    <div class="input-row">
                                                        <input type="tel" name="seller_phone" id="seller_phone" class="input-field" value="" placeholder="MOBILE NO"  /> <?php echo $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter the phone no to be displayed on Ad.</p>':''; ?>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/beta/resources/views/theme/createclassifieds.blade.php ENDPATH**/ ?>