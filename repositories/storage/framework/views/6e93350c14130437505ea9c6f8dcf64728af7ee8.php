...
<?php if($ads->count() > 0): ?>
 ...
 <?php $__currentLoopData = $ads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="topdetailintoprt" id="mobilecustomcss" style=" float: left; ">
            <div style=" padding:5%;" >
					<?php if ($ad->business_image== "") { ?>
							<a href="<?php echo e(route('single_ad', [$ad->id, $ad->slug])); ?>">
							    <img src="<?php echo url('/');?>/uploads/placeholder.png"  class="img-circle crop" style="margin-top: -71px;"></a>
							<?php } else { ?>
							<a href="<?php echo e(route('single_ad', [$ad->id, $ad->slug])); ?>">
							    <img src="<?php echo url('/');?>/uploads/businesslogo/<?php echo $ad->business_image;?>"  class="img-circle crop" style="margin-top: -71px;"></a>
							<?php } ?>
						<span >	<h3 style="font-size:12px"><a href="<?php echo e(route('single_ad', [$ad->id, $ad->slug])); ?>"><?php echo e($ad->seller_name); ?></a> </h3>
							<p style="font-size:12px"><?php echo e($ad->designation); ?> </p>
...
<!--						<div class="profinto" style="margin: 10px;">-->
						
							<!--<span> <a href="<?php echo e(route('single_ad', [$ad->id, $ad->slug])); ?>" class="btn theme-btn"  style="background-color:#191a50;"> VIEW </a> </span>-->
<!--						</div>-->

						<div class="socialinto" style="text-align: justify;">
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\magas_services\resources\views/pro.blade.php ENDPATH**/ ?>