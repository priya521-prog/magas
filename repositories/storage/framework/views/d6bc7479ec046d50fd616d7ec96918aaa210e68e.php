                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <!--<h1 class="page-header"> <?php echo e($title); ?>-->
                             <h1 class="page-header"> Create New Whitepaper
                                <a href="<?php echo e(route('whitepaper_create')); ?>" class="btn btn-info pull-right"> <i class="fa fa-floppy-o"></i> Create New Whitepaper</a>
                            </h1>
                        </div> <!-- /.col-lg-12 -->
                    </div> <!-- /.row -->
                <?php endif; ?>
                                ...
                                <table class="table table-bordered table-striped" >
                                    ...
                                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="posts/edit/<?php echo $post->slug;?>" class="btn btn-primary"><i class="fa fa-edit"></i> </a><a href="javascript:;" class="btn btn-danger deletePage" data-slug="<?php echo $post->slug;?>"><i class="fa fa-trash"></i> </a>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/admin/whitepaper.blade.php ENDPATH**/ ?>