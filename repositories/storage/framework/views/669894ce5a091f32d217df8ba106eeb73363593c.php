...
<?php echo $errors->has('ad_title')? '<p class="help-block" style="color:red;">Please enter the Title. </p>':''; ?>
                                                     ...
                                                     <div class="input-row">
                                                        <input type="text" name="company_name" id="" class="input-field" value="<?php echo e(old('company_name')); ?>" placeholder="COMPANY NAME"  />
                 ...
                 <div class="input-row">
                                ...
                                <select class="form-control select2" name="affilate_code">
                                    ...
                                    <?php $__currentLoopData = $query; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $queries): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <!--<option value="<?php echo e($queries->affiliate_code); ?>"><?php echo e($queries->affiliate_code); ?></option>-->
                                          ...
                                          <option value="<?php echo e($queries->affiliate_code); ?>" <?php echo e(old('affilate_code') == '$queries->affiliate_code' ? 'selected' :''); ?>><?php echo e($queries->affiliate_code); ?></option>
						...
						<div class="box-heading">
							...
							CONTRACT: For Validation purpose only, It will not be published. 
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="seller_name" id="seller_name" class="input-field" value="<?php echo e(old('seller_name')); ?>" placeholder="ENTER FULL NAME"/>
...
<span class="word_preview"></span>
 ...
 <?php echo $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email id.</p>':''; ?>
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="seller_phone" id="seller_phone" class="input-field" value="<?php echo e(old('seller_phone')); ?>"  placeholder="ENTER PHONE"/> 
...
<!--</div>-->
<div class="input-row">
                                                        <input type="text" name="address" id="address" class="input-field" value="<?php echo e(old('address')); ?>" placeholder="LOCATION"/>
 <?php echo $errors->has('address')? '<p class="help-block"style="color:red;">Please enter location</p>':''; ?>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/theme/create_bizzad.blade.php ENDPATH**/ ?>