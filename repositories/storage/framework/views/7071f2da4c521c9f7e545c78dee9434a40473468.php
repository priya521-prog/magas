...
?>
 ...
 <!--<li><a href="<?php echo e(route('profile1')); ?>" id="changecolor" >PDF Report</a></li>-->
            ...
            <li> <a href="<?php echo e(route('fetch_user')); ?>" id="changecolor">Assign Affilate Code</a> </li>
              <li> <a href="<?php echo e(route('premium_status')); ?>" id="changecolor">Update Premium</a> </li>
...
<?php /**PATH /home/beta1magas/public_html/resources/views/admin/sidebar_menu.blade.php ENDPATH**/ ?>