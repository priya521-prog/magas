                                        ...
                                        <div class="box">
                                            <div class="add-images">
                                                <div class="custom-file-upload input-row">
                                                        LOGO IMAGE (Recommended 200*200)<br/><input type="file" id="filescustommedia" value="UPLOAD PROFILE PIC" name="filescustommedia" required/><br/><br/>
						     ...
						     <div class="custom-file-upload input-row">
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="ad_title" id="" class="input-field" value="" placeholder="TITLE"  required/>
...
<!--                                                    </div>-->
 ...
 <!--<?php echo $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email id.</p>':''; ?>-->
                                                    ...
                                                    <!--<div class="input-row">-->
                                                    <!--    <input type="tel" name="seller_phone" id="seller_phone" class="input-field" value="" pattern="[+][0-9]{2,3}[-][0-9]{10}" placeholder="+91-9999999999"  /> <?php echo $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter the phone no.</p>':''; ?>-->
                                                    <!--</div>-->
                                                    <div class="input-row">
                                                        <input type="text" name="seller_phone" id="seller_phone" class="input-field" value=""  placeholder="Enter Phone"  />
                                                        <!--<?php echo $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter the phone no.</p>':''; ?>-->
                                                    </div>
                                                     <div class="input-row">
                                                        <input type="text" name="seller_website" id="seller_website" class="input-field" value="" placeholder="WEBSITE"  />
                                                        <!--<?php echo $errors->has('seller_website')? '<p class="help-block"style="color:red;">Please enter website.</p>':''; ?>-->
                                                    </div>
                                                     <div class="input-row">
                                                        <input type="text" name="social_media_link" id="social_media_link" class="input-field" value="" placeholder="SOCIAL MEDIA LINK"  required/>
                                                        <!--<?php echo $errors->has('social_media_link')? '<p class="help-block"style="color:red;">Please enter social media link.</p>':''; ?>-->
                                                    </div>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/theme/create_whitepaper.blade.php ENDPATH**/ ?>