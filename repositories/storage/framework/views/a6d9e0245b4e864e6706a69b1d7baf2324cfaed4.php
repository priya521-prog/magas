...
<?php $__env->startSection('main'); ?>
			...
			<div class="listingbody">
                ...
                <div class="modern-home-search-bar-wrap">
                        <div class="search-wrapper">
                            <form class="form-inline" action="<?php echo e(route('whitepaper_list')); ?>" method="get"> <?php echo csrf_field(); ?>
                               ...
                               // dd($countries);
                                ...
                                <button type="submit" class="btn theme-btn"> <i class="$adsfa fa-search"></i> GO</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="detailbannerprt">
							...
							<div class="innercontDetail">
								<div class="">
									...
									<?php } else { ?>
									<img src="../../uploads/businesslogo/<?php echo $ad->business_image;?>" style="width:200px">
									<?php } ?>
								</div>
							</div>
				</div>
					...
					<div class="col-md-8">
						<div class="leftquestionprt">
							...
							<div class="innerinfopannel">
								...
								<p style="color:#181b4f;font-size:18px"><b>SYNOPSIS</b></p>
                                                                        <p><?php echo html_entity_decode($ad->description); ?> </p>
                                                                        
                            <div class="gettouchprt" style="background:none">
                                <?php //dd($ad); ?>
    ...
    //dd($login_id);
       $login_type=$login_user->user_type;
							   if($login_type=='admin'){
					           ?>
					        	 &nbsp &nbsp &nbsp<a class="btn theme-btn" style="background-color:#191a50;"  href="<?php echo e(route('editwhitepaper', [$ad->id])); ?>">Edit </a>
        ...
        <div class="modal-body ">
            ...
            <div class="row">
                            <div class="col-md-12">
                                <div class="form-group <?php echo e($errors->has('name')? 'has-error':''); ?>">
                                    <label for="name"><?php echo app('translator')->get('app.name'); ?></label>
                                    <input type="text" class="form-control" id="name" name="name" placeholder="<?php echo app('translator')->get('app.enter_name'); ?>" readonly value="<?php echo $login_name; ?>"/>
                                    <?php echo $errors->has('name')? '<p class="help-block">'.$errors->first('name').'</p>':''; ?>

                                </div>
                                <div class="form-group <?php echo e($errors->has('email')? 'has-error':''); ?>">
                                    <label for="email"><?php echo app('translator')->get('app.email_address'); ?></label>
                                        <input type="email" class="form-control" id="email" placeholder="<?php echo app('translator')->get('app.enter_email_address'); ?>" name="email" value="<?php echo $login_email; ?>" readonly />
                                       <?php echo $errors->has('email')? '<p class="help-block">'.$errors->first('email').'</p>':''; ?>
...
<input type ="hidden" name="sel_email" id="sel_email" value="<?php echo $ad->user->email; ?>">
<input type ="hidden" name="fullpageurl" id="fullpageurl"  value="<?php echo url()->full();?>">
                            <div class="col-md-12">
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sermagas/public_html/resources/views/theme/modern/whitepaper_adedit.blade.php ENDPATH**/ ?>