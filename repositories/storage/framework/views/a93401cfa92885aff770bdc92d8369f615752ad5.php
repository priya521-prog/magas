  ...
  <div class="main">
            <div class="custom-container">
                ...
                <?php echo $__env->make('admin.flash_msg', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <div class="row">
                            <div class="col-sm-12">
                        <form action="" id="businessadsPostForm" name="businessadsPostForm" class="form-horizontal" enctype="multipart/form-data" method="post"> <?php echo csrf_field(); ?>
                                <div class="form-tabs">
                                    <ul>
...
<!--<?php echo $errors->has('ad_title')? '<p class="help-block" style="color:red;">Please enter the Title. </p>':''; ?>-->
                                                     ...
                                                     <div class="input-row">
                                                        <input type="text" name="company_name" id="" class="input-field" value="" placeholder="COMPANY NAME" required />
						...
						<div class="box-heading">
							...
							CONTRACT: For Validation purpose only, It will not be published. 
                                                    ...
                                                    <div class="input-row">
                                                        ...
                                                        <!--<?php echo $errors->has('seller_name')? '<p class="help-block"style="color:red;">Please enter Full Name.</p>':''; ?>-->
<span class="word_preview"></span>
 ...
 <!--<?php echo $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email id.</p>':''; ?>-->
                                                    ...
                                                    <div class="input-row">
                                                        ...
                                                        <!--<?php echo $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter the phone no.</p>':''; ?>-->
                                                    </div>
...
<div class="custom-file-upload input-row"><span class="box-heading" > COMPANY BROCHURE</span>
 ...
 <div class="input-row"> 
	<input type="text" class="form-control" id="address" value="" name="address" placeholder="<?php echo app('translator')->get('app.address'); ?>" required>
...
<?php echo $__env->make('layout.main-front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beta1magas/public_html/resources/views/theme/previewbizz.blade.php ENDPATH**/ ?>