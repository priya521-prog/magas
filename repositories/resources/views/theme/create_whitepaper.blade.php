                                        ...
                                        <div class="box">
                                            <div class="add-images">
                                                <div class="custom-file-upload input-row">
                                                        LOGO IMAGE (Recommended 200*200)<br/><input type="file" id="filescustommedia" value="UPLOAD PROFILE PIC" name="filescustommedia" /><br/><br/>
						     ...
						     <div class="custom-file-upload input-row">
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="ad_title" id="" class="input-field" value="{{ old('ad_title') }}" placeholder="TITLE"/>
...
<!--                                                    </div>-->
                                ...
                                <p class="text-info">  A description will help user to know details about your Business</p>
                                            ...
                                            <div class="box-right">
                                                ...
                                                <div class="sign-up-form">
                                                    ...
                                                    <!--</div>-->
                                                    <!--<div class="input-row">-->
                                                    <!--    <input type="text" name="seller_name" id="seller_name" class="input-field" value="" placeholder="ENTER FULL NAME"  /> {!! $errors->has('seller_name')? '<p class="help-block"style="color:red;">Please enter Full Name.</p>':'' !!}-->
 ...
 {!! $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email id.</p>':'' !!}
                                                    ...
                                                    <!--<div class="input-row">-->
                                                    <!--    <input type="tel" name="seller_phone" id="seller_phone" class="input-field" value="" pattern="[+][0-9]{2,3}[-][0-9]{10}" placeholder="+91-9999999999"  /> {!! $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter the phone no.</p>':'' !!}-->
                                                    <!--</div>-->
                                                    <div class="input-row">
                                                     ...
                                                     <div class="input-row">
                                                        <input type="text" name="seller_website" id="seller_website" class="input-field" value="{{ old('seller_website') }}" placeholder="WEBSITE"  />
                                                        <!--{!! $errors->has('seller_website')? '<p class="help-block"style="color:red;">Please enter website.</p>':'' !!}-->
                                                    </div>
                                                     <div class="input-row">
                                                        <input type="text" name="social_media_link" id="social_media_link" class="input-field" value="{{ old('social_media_link') }}" placeholder="SOCIAL MEDIA LINK"/>
                                                        {!! $errors->has('social_media_link')? '<p class="help-block"style="color:red;">Please enter social media link.</p>':'' !!}
                                                    </div>
...
<!-- <div class="input-row"> -->
<!--	<input type="text" class="form-control" id="address" value="" name="address" placeholder="@lang('app.address')">-->
