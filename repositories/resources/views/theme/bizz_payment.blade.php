...
<div class="main">
 ...
 //dd($payment);
    ?>
                     <a href="javascript:void(0)" class="btn btn-sm btn-primary float-right buy_now" name="pay" id="pay" data-amount="7545" data-id="<?php echo $invoice; ?>">Pay Now</a> 
...
//encode  : true,
       ...
       // response.setHeader("Set-Cookie", "HttpOnly;Secure;SameSite=Strict");
                    ...
                    //  window.location.href = SITEURL + 'thank-you';
                      window.location.href = '{{ route('bizz-success') }}';
