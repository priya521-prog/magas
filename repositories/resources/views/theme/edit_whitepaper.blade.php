  ...
  <div class="main">
            <div class="custom-container">
                ...
                @include('admin.flash_msg')
                        <div class="row">
                            <div class="col-sm-12">
                        <form action="/whitepaper/edit/{{$ads->id}}" id="businessadsPostForm" class="form-horizontal" enctype="multipart/form-data" method="post"> @csrf
                                <div class="form-tabs">
                                    <ul>
                                        ...
                                        <div class="box">
                                            <div class="add-images">
                                                <div class="custom-file-upload input-row">
                                                        LOGO IMAGE (Recommended 200*200)<br/>
						     ...
						     <div class="custom-file-upload input-row">
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="ad_title" id="" class="input-field" value="{{$ads->title }}" placeholder="TITLE"  />
...
<!--                                                    </div>-->
 ...
 {!! $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email id.</p>':'' !!}
                                                    ...
                                                    <div class="input-row">
                                                     ...
                                                     <div class="input-row">
                                                        <input type="text" name="seller_website" id="seller_website" class="input-field" value="{{$ads->seller_website }}" placeholder="WEBSITE"  /> {!! $errors->has('seller_website')? '<p class="help-block"style="color:red;">Please enter website.</p>':'' !!}
                                                    </div>
                                                     <div class="input-row">
                                                        <input type="text" name="social_media_link" id="social_media_link" class="input-field" value="{{$ads->social_media_link }}" placeholder="SOCIAL MEDIA LINK"  /> {!! $errors->has('social_media_link')? '<p class="help-block"style="color:red;">Please enter social media link.</p>':'' !!}
                                                    </div>
