                                        ...
                                        <div class="box">
                                            <div class="add-images">
                                                <div class="custom-file-upload input-row">
                                                        LOGO IMAGE (Recommended 250*250)<br/><input type="file" id="filescustommedia" value="value="{{ old('filescustommedia') }}"" name="filescustommedia" /><br/><br/>
{!! $errors->has('filescustommedia')? '<p class="help-block" style="color:red;">Please Upload Image. </p>':'' !!}
                                                        <div class="clearfix"></div>
                                                    </div>

						     <div class="custom-file-upload input-row">
                                                        COVER/PROFILE IMAGE (RECOMMENDED 851*315)<br/><input type="file" id="file" value="{{ old('filescustomone') }}" name="filescustomone" />
                                                        <div class="clearfix"></div>
                                                    </div>
                                            </div>
                                            <div class="clearfix"></div>
...
<!--                                                    </div>-->
 ...
 {!! $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email id.</p>':'' !!}
                                                    ...
                                                    <!--<div class="input-row">-->
                                                    <!--    <input type="text" name="seller_phone" id="seller_phone" class="input-field" value="" pattern="[+][0-9]{2,3}[-][0-9]{10}" placeholder="+91-9999999999"  /> {!! $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter the phone no.</p>':'' !!}-->
                                                    <!--</div>-->
                                                    <div class="input-row">
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="seller_req" id="seller_req" class="input-field" value="{{ old('seller_req') }}"  placeholder="Enter REQUIREMENT"/>
                                                        {!! $errors->has('seller_req')? '<p class="help-block" style="color:red;">Please enter Requirement</p>':'' !!}
                                                    </div>
                                                    
 <!--                                                   <div class="input-row">-->
 <!--                                                       <input type="text" name="seller_req" id="seller_req" class="input-field" value="{{ old('seller_req') }}" placeholder="REQUIREMENT"/>-->
 <!--{!! $errors->has('requirement')? '<p class="help-block"style="color:red;">Please enter Requirement</p>':'' !!}-->
 <!--                                                   </div>-->
...
<!-- <div class="input-row"> -->
<!--	<input type="text" class="input-field" id="address" value="{{ old('address') }}" name="address" placeholder="LOCATION">-->
                                                    ...
                                                    <div class="input-row">
                                                        <div class="select">
                                                            <select id="state_select" name="state" class="form-control select2">
                                                                ...
                                                                <option value="{{ old('state') }}">Please Select State</option>
                                                            </select>
                                                        </div>
