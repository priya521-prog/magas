                            ...
                            <div class="alacarte-menu" style="margin-top: 30px;">
                                ...
                                <div class="title">
                                    ...
                                    <ul>
                                            <li class="each-form-tabh active">
                                                 <a style="color:#fff;" href="{{ route('packages') }}" style="cursor: pointer;">
                                ...
                                <div class="tabpanel">
                                    <ul>
                                        ...
                                        <li class="each-form-tab">
                                            <div class="curved-buttons">
                                                 <a style="color:#fff" href="{{ route('contact_us_page') }}" style="cursor: pointer;">
                                            Contact
                                        </a>
                                            </div>
                                        </li>
                                ...
                                <!--    <li class="each-form-tab">-->
                                <!--        <a  href="{{ route('contact_us_page') }}" style="cursor: pointer;">-->
                                <!--            Contact-->
                                <!--        </a>-->
                                <!--    </li>-->
                                <!--</ul>-->
