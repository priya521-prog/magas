  ...
  <div class="main">
            <div class="custom-container">
                ...
                @include('admin.flash_msg')
                        <div class="row">
                            <div class="col-sm-12">
                        <form action="" id="businessadsPostForm" name="businessadsPostForm" class="form-horizontal" enctype="multipart/form-data" method="post"> @csrf
                                <div class="form-tabs">
                                    <ul>
                                    ...
                                    <div class="bizz-content tab">
                                        <div class="curved-buttons" id="cre_biz">
                                            Create New Bizz
                                        </div>
                                        <div class="curved-buttons" id="check_rev" style="display:none">
                                            Review Before Submit
                                        </div>
                                        <div class="box">
                                            <div class="add-images">
                                                <div class="custom-file-upload input-row">
                                                        LOGO IMAGE (Recommended 250*250)<br/><input type="file" id="filescustommedia" value="UPLOAD PROFILE PIC" name="filescustommedia" required/><br/><br/>
<!--{!! $errors->has('filescustommedia')? '<p class="help-block" style="color:red;">Please Upload Image. </p>':'' !!}-->
                                                        <div class="clearfix"></div>
                                                    </div>
						     ...
						     <div class="custom-file-upload input-row">
                                            ...
                                            <div class="box-left">
                                                <div class="sign-up-form">
                                                    ...
                                                    <div class="input-row">
                                                        <input type="text" name="ad_title" id="" class="input-field"  value="<?php echo $request->ad_title?>" placeholder="HEADING"  required/>
<!--{!! $errors->has('ad_title')? '<p class="help-block" style="color:red;">Please enter the Title. </p>':'' !!}-->
                                                    </div>
                                                     <div class="input-row">
                                                        <input type="text" name="company_name" id="" class="input-field" value="<?php echo $request->company_name?>" placeholder="COMPANY NAME" required />
<!--{!! $errors->has('company_name')? '<p class="help-block" style="color:red;">Please enter the company name. </p>':'' !!}-->
                                                    </div>
...
<div class="input-row">
                 ...
                 <div class="input-row">
                            <label for="code">Affiliate Code</label>
                                ...
                                <select class="form-control select2" name="affilate_code">
                                    <option value="<?php echo $request->affiliate_code ?>">Select Affiliate Code</option>
						...
						<div class="box-heading">
                                                    About Us
                                                     ...
                                                     <div class="input-row">
						    <textarea name="ad_description" id="ad_description" class="form-control" rows="8" required></textarea>
							...
							CONTRACT: For Validation purpose only, It will not be published. 
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    <div class="input-row">
                                                        <input type="text" name="seller_name" id="seller_name" class="input-field" value="" placeholder="ENTER FULL NAME"  required/>
                                                        <!--{!! $errors->has('seller_name')? '<p class="help-block"style="color:red;">Please enter Full Name.</p>':'' !!}-->
<span class="word_preview"></span>
                                                    </div>

                                                   
                                                    <div class="input-row">
                                                        <input type="email" name="seller_email" id="" class="input-field" value="" placeholder="EMAIL" required />
 <!--{!! $errors->has('seller_email')? '<p class="help-block"style="color:red;">Please enter the email id.</p>':'' !!}-->
                                                    </div>
                                                    <div class="input-row">
                                                        <input type="text" name="seller_phone" id="seller_phone" class="input-field" value=""  placeholder="enter phone"  required/> 
                                                        <!--{!! $errors->has('seller_phone')? '<p class="help-block"style="color:red;">Please enter the phone no.</p>':'' !!}-->
                                                    </div>

<div class="custom-file-upload input-row"><span class="box-heading" > COMPANY BROCHURE</span>
                                                        <input type="file" id="filescustom" name="filescustom" required/><br/><br/>
						    ...
						    <div class="input-row">
                                                        <div class="select">
                                                            <select class="form-control select2" name="servicetype" id="servicetype" required>
 ...
 <div class="input-row"> 
	<input type="text" class="form-control" id="address" value="" name="address" placeholder="@lang('app.address')" required>
                                                    ...
                                                    <div class="input-row">
                                                        <div class="select">
                                                            <select name="country" id="slct" class="form-control select2" required>
...
<input type="button" name="review" id="review" class="custom-button" value="Review & Edit" />
                                <!--<input type="submit" id="submit" class="custom-button"/>-->
                               
                                <!--<button type="" class="custom-button" id="submit" style="display:none">Submit</button>-->
                                <!--<button type="button" class="custom-button" id="submit" style="display:block" onClick="preview()">Preview</button>-->
<button type="submit" class="custom-button" id="submit" style="display:none">Submit</button>
...
<!--                      <input type="hidden" name="business" value="info@magas.services">-->
...
<script src="{{ asset('assets/plugins/ckeditor/ckeditor.js') }}"></script>
 ...
 <script type="text/javascript">
   function preview(){
   //alert("hi");
   txt1.innerText=document.businessadsPostForm.ad_title.value;
   txt2.innerText=document.businessadsPostForm.ad_title.value;
   }
    </script>
<script>
...
// });
 $("#review").on('click', function () {
     alert("Please review before submitting the form");
            $("#submit").show();
             $("#review").hide();
        });
