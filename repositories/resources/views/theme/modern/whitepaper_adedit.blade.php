...
@section('main')
			...
			<div class="listingbody">
                ...
                <div class="modern-home-search-bar-wrap">
                        <div class="search-wrapper">
                            <form class="form-inline" action="{{ route('whitepaper_list') }}" method="get"> @csrf
    ...
    //dd($login_id);
       $login_type=$login_user->user_type;
							   if($login_type=='admin'){
					           ?>
					        	 &nbsp &nbsp &nbsp<a class="btn theme-btn" style="background-color:#191a50;"  href="{{  route('editwhitepaper', [$ad->id]) }}">Edit </a>
