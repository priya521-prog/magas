...
@if($ads->count() > 0)
						...
						<div class="profinto">
					<h2>
                            <a href="{{ route('classifieds', ['user_id'=>$ad->user_id]) }}" style="font-size: 15px !important;"> {{ $ad->seller_name }}</a></h2>
							<h3 style="font-size: 15px !important;"><?php  echo ucwords($ad->sub_category->category_name);?></h3>
							
							<span style="font-size: 14px;"><i class="fa fa-map-marker" style="width: 20px;height: 20px;text-align: center;ine-height: 20px;"></i> {{ $ad->country->country_name  }}</span>
						</div>
...
<div class="profinto" style="margin-bottom:20px;">
	<h2><a href="{{  route('single_ad', [$ad->id, $ad->slug]) }}" style="font-size: 15px !important;">{{ $ad->title }} </a></h2>	
...
@if($ads->count() > 0)
						...
						<div class="profinto">
					<h2>
                            <a href="{{  route('single_ad', [$ad->id, $ad->slug]) }}" style="font-size: 15px !important;"> {{ $ad->seller_name }}</a></h2>
							<h3 style="font-size: 15px !important;"><?php  echo ucwords($ad->sub_category->category_name);?></h3>
