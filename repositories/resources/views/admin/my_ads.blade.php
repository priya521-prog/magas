                                ...
                                @foreach($ads as $ad)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!--<a href="{{ route('edit_ad1',[$ad->id] ) }}" class="btn btn-primary"><i class="fa fa-edit"></i> </a>-->
                                            <a href="{{ route('delete_ads') }}" class="btn btn-danger deleteAds" data-slug="{{ $ad->slug }}"><i class="fa fa-trash"></i> </a>
                                        </td>
                                    </tr>
                                @endforeach
